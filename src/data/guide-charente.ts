...
export const GUIDE_ENTRIES: GuideEntry[] = [
...

  {
    ...
    fr: {
      ...
      history: "La Rochelle, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
    ...
    en: {
      ...
      history: "La Rochelle, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à La Rochelle, une adresse représentative du charme de la Charente-Maritime.",
      history: "La Rochelle, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Rochefort, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Rochefort, a fine example of Charente-Maritime's coastal charm.",
      history: "Rochefort, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Royan, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Royan, a fine example of Charente-Maritime's coastal charm.",
      history: "Royan, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Saintes, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Saintes, a fine example of Charente-Maritime's coastal charm.",
      history: "Saintes, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Saint-Jean-d'Angély, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Saint-Jean-d'Angély, a fine example of Charente-Maritime's coastal charm.",
      history: "Saint-Jean-d'Angély, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à Saint-Jean-d'Angély, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Jean-d'Angély, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "La Table du Pertuis à Saint-Jean-d'Angély, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Jean-d'Angély, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Le Comptoir des Huîtres à Saint-Jean-d'Angély, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Jean-d'Angély, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Sentier du littoral à Saint-Jean-d'Angély, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Jean-d'Angély, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Saint-Jean-d'Angély, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Jean-d'Angély, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Jonzac, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Jonzac, a fine example of Charente-Maritime's coastal charm.",
      history: "Jonzac, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Marennes, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Marennes, a fine example of Charente-Maritime's coastal charm.",
      history: "Marennes, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Saint-Martin-de-Ré, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Saint-Martin-de-Ré, a fine example of Charente-Maritime's coastal charm.",
      history: "Saint-Martin-de-Ré, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à Saint-Martin-de-Ré, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Martin-de-Ré, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Le Comptoir des Huîtres à Saint-Martin-de-Ré, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Martin-de-Ré, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Saint-Martin-de-Ré, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Martin-de-Ré, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Ars-en-Ré, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Ars-en-Ré, a fine example of Charente-Maritime's coastal charm.",
      history: "Ars-en-Ré, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "La Flotte, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in La Flotte, a fine example of Charente-Maritime's coastal charm.",
      history: "La Flotte, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Le Bois-Plage-en-Ré, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Le Bois-Plage-en-Ré, a fine example of Charente-Maritime's coastal charm.",
      history: "Le Bois-Plage-en-Ré, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à Le Bois-Plage-en-Ré, une adresse représentative du charme de la Charente-Maritime.",
      history: "Le Bois-Plage-en-Ré, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "La Table du Pertuis à Le Bois-Plage-en-Ré, une adresse représentative du charme de la Charente-Maritime.",
      history: "Le Bois-Plage-en-Ré, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Le Comptoir des Huîtres à Le Bois-Plage-en-Ré, une adresse représentative du charme de la Charente-Maritime.",
      history: "Le Bois-Plage-en-Ré, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Sentier du littoral à Le Bois-Plage-en-Ré, une adresse représentative du charme de la Charente-Maritime.",
      history: "Le Bois-Plage-en-Ré, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Le Bois-Plage-en-Ré, une adresse représentative du charme de la Charente-Maritime.",
      history: "Le Bois-Plage-en-Ré, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Saint-Pierre-d'Oléron, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Saint-Pierre-d'Oléron, a fine example of Charente-Maritime's coastal charm.",
      history: "Saint-Pierre-d'Oléron, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel de la Plage à Saint-Pierre-d'Oléron, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Pierre-d'Oléron, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à Saint-Pierre-d'Oléron, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Pierre-d'Oléron, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel Le Relais Atlantique in Saint-Pierre-d'Oléron, a fine example of Charente-Maritime's coastal charm.",
      history: "Saint-Pierre-d'Oléron, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
    photos: ["https://commons.wikimedia.org/wiki/Special:FilePath/Eglise_Saint-Pierre-d_Oleron.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Marche_de_Saint-Pierre-d_Oleron.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Maison_des_Aieules_Oleron.jpg?width=1200"],
  },
  {
    ...
    fr: {
      teaser: "La Table du Pertuis à Saint-Pierre-d'Oléron, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Pierre-d'Oléron, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Le Comptoir des Huîtres à Saint-Pierre-d'Oléron, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Pierre-d'Oléron, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Sentier du littoral à Saint-Pierre-d'Oléron, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Pierre-d'Oléron, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Saint-Pierre-d'Oléron, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Pierre-d'Oléron, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Church and historic centre in Saint-Pierre-d'Oléron, a fine example of Charente-Maritime's coastal charm.",
      history: "Saint-Pierre-d'Oléron, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
    photos: ["https://commons.wikimedia.org/wiki/Special:FilePath/Eglise_Saint-Pierre-d_Oleron.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Marche_de_Saint-Pierre-d_Oleron.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Maison_des_Aieules_Oleron.jpg?width=1200"],
  },
  {
    ...
    fr: {
      ...
      history: "Le Château-d'Oléron, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Le Château-d'Oléron, a fine example of Charente-Maritime's coastal charm.",
      history: "Le Château-d'Oléron, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à Le Château-d'Oléron, une adresse représentative du charme de la Charente-Maritime.",
      history: "Le Château-d'Oléron, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "La Table du Pertuis à Le Château-d'Oléron, une adresse représentative du charme de la Charente-Maritime.",
      history: "Le Château-d'Oléron, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Le Comptoir des Huîtres à Le Château-d'Oléron, une adresse représentative du charme de la Charente-Maritime.",
      history: "Le Château-d'Oléron, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Sentier du littoral à Le Château-d'Oléron, une adresse représentative du charme de la Charente-Maritime.",
      history: "Le Château-d'Oléron, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Le Château-d'Oléron, une adresse représentative du charme de la Charente-Maritime.",
      history: "Le Château-d'Oléron, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Saint-Trojan-les-Bains, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Saint-Trojan-les-Bains, a fine example of Charente-Maritime's coastal charm.",
      history: "Saint-Trojan-les-Bains, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel de la Plage à Saint-Trojan-les-Bains, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Trojan-les-Bains, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à Saint-Trojan-les-Bains, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Trojan-les-Bains, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel Le Relais Atlantique in Saint-Trojan-les-Bains, a fine example of Charente-Maritime's coastal charm.",
      history: "Saint-Trojan-les-Bains, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
    photos: ["https://commons.wikimedia.org/wiki/Special:FilePath/Petit_train_de_Saint-Trojan.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Plage_de_Saint-Trojan-les-Bains.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Foret_de_Saint-Trojan.jpg?width=1200"],
  },
  {
    ...
    fr: {
      teaser: "La Table du Pertuis à Saint-Trojan-les-Bains, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Trojan-les-Bains, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Le Comptoir des Huîtres à Saint-Trojan-les-Bains, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Trojan-les-Bains, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Sentier du littoral à Saint-Trojan-les-Bains, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Trojan-les-Bains, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Saint-Trojan-les-Bains, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Trojan-les-Bains, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Church and historic centre in Saint-Trojan-les-Bains, a fine example of Charente-Maritime's coastal charm.",
      history: "Saint-Trojan-les-Bains, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
    photos: ["https://commons.wikimedia.org/wiki/Special:FilePath/Petit_train_de_Saint-Trojan.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Plage_de_Saint-Trojan-les-Bains.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Foret_de_Saint-Trojan.jpg?width=1200"],
  },
  {
    ...
    fr: {
      ...
      history: "Fouras, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Fouras, a fine example of Charente-Maritime's coastal charm.",
      history: "Fouras, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Châtelaillon-Plage, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Châtelaillon-Plage, a fine example of Charente-Maritime's coastal charm.",
      history: "Châtelaillon-Plage, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à Châtelaillon-Plage, une adresse représentative du charme de la Charente-Maritime.",
      history: "Châtelaillon-Plage, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Le Comptoir des Huîtres à Châtelaillon-Plage, une adresse représentative du charme de la Charente-Maritime.",
      history: "Châtelaillon-Plage, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Châtelaillon-Plage, une adresse représentative du charme de la Charente-Maritime.",
      history: "Châtelaillon-Plage, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Surgères, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Surgères, a fine example of Charente-Maritime's coastal charm.",
      history: "Surgères, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Pons, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Pons, a fine example of Charente-Maritime's coastal charm.",
      history: "Pons, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Talmont-sur-Gironde, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Talmont-sur-Gironde, a fine example of Charente-Maritime's coastal charm.",
      history: "Talmont-sur-Gironde, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à Talmont-sur-Gironde, une adresse représentative du charme de la Charente-Maritime.",
      history: "Talmont-sur-Gironde, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "La Table du Pertuis à Talmont-sur-Gironde, une adresse représentative du charme de la Charente-Maritime.",
      history: "Talmont-sur-Gironde, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Le Comptoir des Huîtres à Talmont-sur-Gironde, une adresse représentative du charme de la Charente-Maritime.",
      history: "Talmont-sur-Gironde, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Sentier du littoral à Talmont-sur-Gironde, une adresse représentative du charme de la Charente-Maritime.",
      history: "Talmont-sur-Gironde, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Talmont-sur-Gironde, une adresse représentative du charme de la Charente-Maritime.",
      history: "Talmont-sur-Gironde, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Brouage, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Brouage, a fine example of Charente-Maritime's coastal charm.",
      history: "Brouage, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Saint-Georges-de-Didonne, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Saint-Georges-de-Didonne, a fine example of Charente-Maritime's coastal charm.",
      history: "Saint-Georges-de-Didonne, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel de la Plage à Saint-Georges-de-Didonne, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Georges-de-Didonne, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à Saint-Georges-de-Didonne, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Georges-de-Didonne, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel Le Relais Atlantique in Saint-Georges-de-Didonne, a fine example of Charente-Maritime's coastal charm.",
      history: "Saint-Georges-de-Didonne, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
    photos: ["https://commons.wikimedia.org/wiki/Special:FilePath/Plage_de_Saint-Georges-de-Didonne.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Eglise_de_Saint-Georges-de-Didonne.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Port_de_Saint-Georges-de-Didonne.jpg?width=1200"],
  },
  {
    ...
    fr: {
      teaser: "La Table du Pertuis à Saint-Georges-de-Didonne, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Georges-de-Didonne, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Le Comptoir des Huîtres à Saint-Georges-de-Didonne, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Georges-de-Didonne, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Le Comptoir des Huîtres in Saint-Georges-de-Didonne, a fine example of Charente-Maritime's coastal charm.",
      history: "Saint-Georges-de-Didonne, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
    photos: ["https://commons.wikimedia.org/wiki/Special:FilePath/Plage_de_Saint-Georges-de-Didonne.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Eglise_de_Saint-Georges-de-Didonne.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Port_de_Saint-Georges-de-Didonne.jpg?width=1200"],
  },
  {
    ...
    fr: {
      teaser: "Sentier du littoral à Saint-Georges-de-Didonne, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Georges-de-Didonne, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Saint-Georges-de-Didonne, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Georges-de-Didonne, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Church and historic centre in Saint-Georges-de-Didonne, a fine example of Charente-Maritime's coastal charm.",
      history: "Saint-Georges-de-Didonne, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
    photos: ["https://commons.wikimedia.org/wiki/Special:FilePath/Plage_de_Saint-Georges-de-Didonne.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Eglise_de_Saint-Georges-de-Didonne.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Port_de_Saint-Georges-de-Didonne.jpg?width=1200"],
  },
  {
    ...
    fr: {
      ...
      history: "Meschers-sur-Gironde, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Meschers-sur-Gironde, a fine example of Charente-Maritime's coastal charm.",
      history: "Meschers-sur-Gironde, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à Meschers-sur-Gironde, une adresse représentative du charme de la Charente-Maritime.",
      history: "Meschers-sur-Gironde, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel Le Relais Atlantique in Meschers-sur-Gironde, a fine example of Charente-Maritime's coastal charm.",
      history: "Meschers-sur-Gironde, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
    photos: ["https://commons.wikimedia.org/wiki/Special:FilePath/Grottes_de_Meschers.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Meschers-sur-Gironde_port.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Falaises_de_Meschers.jpg?width=1200"],
  },
  {
    ...
    fr: {
      teaser: "La Table du Pertuis à Meschers-sur-Gironde, une adresse représentative du charme de la Charente-Maritime.",
      history: "Meschers-sur-Gironde, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Le Comptoir des Huîtres à Meschers-sur-Gironde, une adresse représentative du charme de la Charente-Maritime.",
      history: "Meschers-sur-Gironde, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Sentier du littoral à Meschers-sur-Gironde, une adresse représentative du charme de la Charente-Maritime.",
      history: "Meschers-sur-Gironde, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Meschers-sur-Gironde, une adresse représentative du charme de la Charente-Maritime.",
      history: "Meschers-sur-Gironde, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Church and historic centre in Meschers-sur-Gironde, a fine example of Charente-Maritime's coastal charm.",
      history: "Meschers-sur-Gironde, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
    photos: ["https://commons.wikimedia.org/wiki/Special:FilePath/Grottes_de_Meschers.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Meschers-sur-Gironde_port.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Falaises_de_Meschers.jpg?width=1200"],
  },
  {
    ...
    fr: {
      ...
      history: "Aytré, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Aytré, a fine example of Charente-Maritime's coastal charm.",
      history: "Aytré, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Angoulins, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Angoulins, a fine example of Charente-Maritime's coastal charm.",
      history: "Angoulins, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Yves, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Yves, a fine example of Charente-Maritime's coastal charm.",
      history: "Yves, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Tonnay-Charente, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Tonnay-Charente, a fine example of Charente-Maritime's coastal charm.",
      history: "Tonnay-Charente, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à Tonnay-Charente, une adresse représentative du charme de la Charente-Maritime.",
      history: "Tonnay-Charente, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Le Comptoir des Huîtres à Tonnay-Charente, une adresse représentative du charme de la Charente-Maritime.",
      history: "Tonnay-Charente, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Tonnay-Charente, une adresse représentative du charme de la Charente-Maritime.",
      history: "Tonnay-Charente, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Saint-Savinien, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Saint-Savinien, a fine example of Charente-Maritime's coastal charm.",
      history: "Saint-Savinien, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à Saint-Savinien, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Savinien, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Saint-Savinien, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Savinien, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Taillebourg, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Taillebourg, a fine example of Charente-Maritime's coastal charm.",
      history: "Taillebourg, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Taillebourg, une adresse représentative du charme de la Charente-Maritime.",
      history: "Taillebourg, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Aulnay, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Aulnay, a fine example of Charente-Maritime's coastal charm.",
      history: "Aulnay, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Matha, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Matha, a fine example of Charente-Maritime's coastal charm.",
      history: "Matha, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Saint-Palais-sur-Mer, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Saint-Palais-sur-Mer, a fine example of Charente-Maritime's coastal charm.",
      history: "Saint-Palais-sur-Mer, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à Saint-Palais-sur-Mer, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Palais-sur-Mer, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel Le Relais Atlantique in Saint-Palais-sur-Mer, a fine example of Charente-Maritime's coastal charm.",
      history: "Saint-Palais-sur-Mer, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
    photos: ["https://commons.wikimedia.org/wiki/Special:FilePath/Plage_de_Saint-Palais-sur-Mer.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Sentier_des_douaniers_Saint-Palais.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Conche_du_Platin_Saint-Palais.jpg?width=1200"],
  },
  {
    ...
    fr: {
      teaser: "La Table du Pertuis à Saint-Palais-sur-Mer, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Palais-sur-Mer, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Le Comptoir des Huîtres à Saint-Palais-sur-Mer, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Palais-sur-Mer, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Sentier du littoral à Saint-Palais-sur-Mer, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Palais-sur-Mer, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Saint-Palais-sur-Mer, une adresse représentative du charme de la Charente-Maritime.",
      history: "Saint-Palais-sur-Mer, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Church and historic centre in Saint-Palais-sur-Mer, a fine example of Charente-Maritime's coastal charm.",
      history: "Saint-Palais-sur-Mer, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
    photos: ["https://commons.wikimedia.org/wiki/Special:FilePath/Plage_de_Saint-Palais-sur-Mer.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Sentier_des_douaniers_Saint-Palais.jpg?width=1200", "https://commons.wikimedia.org/wiki/Special:FilePath/Conche_du_Platin_Saint-Palais.jpg?width=1200"],
  },
  {
    ...
    fr: {
      ...
      history: "La Tremblade, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in La Tremblade, a fine example of Charente-Maritime's coastal charm.",
      history: "La Tremblade, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à La Tremblade, une adresse représentative du charme de la Charente-Maritime.",
      history: "La Tremblade, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à La Tremblade, une adresse représentative du charme de la Charente-Maritime.",
      history: "La Tremblade, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Ronce-les-Bains, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Ronce-les-Bains, a fine example of Charente-Maritime's coastal charm.",
      history: "Ronce-les-Bains, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à Ronce-les-Bains, une adresse représentative du charme de la Charente-Maritime.",
      history: "Ronce-les-Bains, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Le Comptoir des Huîtres à Ronce-les-Bains, une adresse représentative du charme de la Charente-Maritime.",
      history: "Ronce-les-Bains, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Ronce-les-Bains, une adresse représentative du charme de la Charente-Maritime.",
      history: "Ronce-les-Bains, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Dolus-d'Oléron, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Dolus-d'Oléron, a fine example of Charente-Maritime's coastal charm.",
      history: "Dolus-d'Oléron, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à Dolus-d'Oléron, une adresse représentative du charme de la Charente-Maritime.",
      history: "Dolus-d'Oléron, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Dolus-d'Oléron, une adresse représentative du charme de la Charente-Maritime.",
      history: "Dolus-d'Oléron, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Rivedoux-Plage, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Rivedoux-Plage, a fine example of Charente-Maritime's coastal charm.",
      history: "Rivedoux-Plage, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    fr: {
      teaser: "Hôtel Le Relais Atlantique à Rivedoux-Plage, une adresse représentative du charme de la Charente-Maritime.",
      history: "Rivedoux-Plage, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      teaser: "Église et centre historique à Rivedoux-Plage, une adresse représentative du charme de la Charente-Maritime.",
      history: "Rivedoux-Plage, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Loix, en Charente-Maritime, conjugue patrimoine littoral et art de vivre atlantique : ruelles anciennes, marché local et proximité de l'océan façonnent depuis des siècles l'identité de la commune, entre pêche, ostréiculture et tourisme balnéaire.",
      tips: "Renseignez-vous sur les horaires saisonniers avant de vous déplacer, ils varient fortement entre l'été et l'hiver sur la côte.",
    },
    en: {
      teaser: "Hôtel du Port in Loix, a fine example of Charente-Maritime's coastal charm.",
      history: "Loix, in Charente-Maritime, blends coastal heritage with Atlantic living: old streets, a local market and closeness to the ocean have shaped the town's identity for centuries, between fishing, oyster farming and seaside tourism.",
      tips: "Check seasonal opening hours before visiting, as they vary greatly between summer and winter along the coast.",
    },
  ...
  },
  {
    ...
    facts: [
      ...
      { fr: "Tous niveaux à marée basse/mi-marée", en: "All levels at low to mid tide" },
    ...
    fr: {
      ...
      history: "La Grande Côte prolonge la Côte Sauvage jusqu"aux dunes de la Coubre. Ce littoral, longtemps redouté des marins pour ses bancs de sable mouvants, a été fixé au XIXe siecle par les plantations de pins maritimes voulues sous le Second Empire. Les blockhaus du Mur de l"Atlantique, aujourd"hui basculés dans le sable et couverts de graffitis, rappellent l"occupation de la poche de Royan jusqu"en avril 1945. Le surf y est arrive dans les annees 1960, apporte par les premiers clubs de Royan.",
      tips: "Baignade et surf uniquement dans les zones surveillees en ete : les courants de baine sont violents. Stationnement au parking de la Grande Côte, depose possible au plus pres par le taxi.",
    },
    en: {
      teaser: "The longest beach of the Cote de Beaute: a powerful, west-facing beach break that works nearly all year.",
      history: "La Grande Cote extends the Wild Coast up to the Coubre dunes. Long feared by sailors for its shifting sandbanks, the shore was stabilised in the 19th century by the maritime pine plantations of the Second Empire. Atlantic Wall bunkers, now tipped into the sand and covered in graffiti, recall the Royan pocket held until April 1945. Surfing arrived in the 1960s with the first Royan clubs.",
      tips: "Swim and surf only in lifeguarded zones in summer: rip currents are strong. Park at the Grande Cote car park, or ask for a door-to-beach taxi drop-off.",
    },
  ...
  },
  {
    ...
    city: "Dolus-d"Oléron",
    facts: [
      { fr: "Spot historique de l"île d"Oléron", en: "Oleron"s historic surf spot" },
    ...
    fr: {
      ...
      history: "Vert-Bois ouvre la Côte Sauvage d"Oléron, une bande de dunes et de pinede plantee au XIXe siecle pour stopper l"ensablement des villages. Le blockhaus echoue sur l"estran, vestige du Mur de l"Atlantique, sert de repere aux surfeurs depuis les annees 1970, quand les premiers clubs oleronais s"y sont installes. La plage reste non urbanisee, protegee au titre des espaces naturels sensibles.",
      tips: "Marée montante conseillee, evitez la basse mer par gros temps. Combinaison indispensable hors juillet-août.",
    },
    en: {
      teaser: "Oleron"s legendary spot: long sandbars, a wild dune and waves that stand up on the first west swell.",
      history: "Vert-Bois opens Oleron"s Wild Coast, a belt of dunes and pine forest planted in the 19th century to stop villages being buried by sand. The stranded Atlantic Wall bunker on the foreshore has been a surfers" landmark since the 1970s, when the island"s first clubs settled here. The beach remains undeveloped, protected as a sensitive natural area.",
      tips: "Incoming tide is best; avoid low tide in heavy weather. A wetsuit is essential outside July-August.",
    },
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Chatelaillon fut d"abord une place forte medievale, capitale des seigneurs de Chatelaillon avant d"être rasee par les ducs d"Aquitaine au XIIe siecle ; la mer a englouti la vieille ville. La station balneaire actuelle nait en 1890 avec l"arrivee du chemin de fer et ses villas Belle Epoque, encore visibles sur le front de mer. La plage, rechargee en sable chaque annee, accueille aujourd"hui ecoles de surf, longboard et paddle.",
      tips: "Vagues modestes : privilegiez les jours de forte houle d"ouest. Location de materiel sur le front de mer, arret taxi devant le casino.",
    },
    en: {
      teaser: "Three kilometres of fine sand facing the Antioche strait: the county"s gentlest spot, perfect for beginners.",
      history: "Chatelaillon was first a medieval stronghold, capital of its own lords before being razed by the dukes of Aquitaine in the 12th century; the sea later swallowed the old town. The present resort was born in 1890 with the railway and its Belle Epoque villas, still lining the seafront. The beach, replenished with sand each year, now hosts surf, longboard and paddle schools.",
  ...
  },
  {
    ...
    facts: [
      ...
      { fr: "Proche de Bonne Anse", en: "Close to Bonne Anse bay" },
    ],
    fr: {
      teaser: "Entre forêt de la Coubre et océan, une plage large où la houle arrive filtrée : idéale pour progresser en famille.",
      history: "La Palmyre est nee de la foret : 8 000 hectares de pins semes a partir de 1808 pour fixer les dunes qui menaçaient les villages de la presqu"ile d"Arvert. La station se developpe dans les annees 1960 autour de son zoo et de son port. Bonne Anse, lagune formee par la fleche de sable de la Coubre, se deplace de plusieurs metres chaque annee et modifie sans cesse les bancs de sable du spot.",
      tips: "Consultez les horaires de maree : le spot fonctionne mieux a mi-maree montante. Nombreux parkings ombrages sous les pins.",
    },
    en: {
  ...
  },
  {
    ...
    city: "Saint-Trojan-les-Bains",
    facts: [
      { fr: "Pointe sud d"Oléron, houle longue", en: "Southern tip of Oleron, long swell" },
      { fr: "Spot calme, cadre forestier", en: "Quiet spot, forest setting" },
      { fr: "Accès par le p"tit train ou la route", en: "Reached by the little train or road" },
    ],
    fr: {
      teaser: "La pointe sud d"Oléron : de longues lignes d"écume, une dune préservée et presque personne hors saison.",
      history: "Gatseau borde la foret domaniale de Saint-Trojan, plantee au XIXe siecle pour arrêter les dunes qui avancaient de plusieurs metres par an. Depuis 1963, un petit train touristique traverse la pinede jusqu"a la plage — unique en France. La pointe, face au pertuis de Maumusson, l"un des passages les plus dangereux de la cote atlantique, offre des vagues longues mais des courants puissants.",
      tips: "Maumusson est reserve aux surfeurs experimentes : ne jamais pagayer seul vers la pointe. Depose possible au bout de la route forestiere.",
    },
    en: {
      teaser: "Oleron"s southern tip: long lines of whitewater, a preserved dune and almost nobody out of season.",
      history: "Gatseau borders the state forest of Saint-Trojan, planted in the 19th century to halt dunes advancing several metres a year. Since 1963 a little tourist train has crossed the pines to the beach — unique in France. The point faces the Maumusson strait, one of the Atlantic coast"s most dangerous passes, giving long waves but powerful currents.",
  ...
  },
  {
    ...
    facts: [
      ...
      { fr: "Face à l"île d"Oléron", en: "Facing Oleron island" },
    ],
    fr: {
      teaser: "Face au viaduc d"Oléron, une plage protégée où l"on rame au lever du jour : le spot des sessions tranquilles.",
      history: "Ronce-les-Bains est nee en 1860 comme station climatique, quand les medecins vantaient l"air resineux de la foret de la Coubre contre la tuberculose. Villas de bord de mer, chapelle de 1901 et ancien tramway de Royan racontent cette Belle Epoque balneaire. Protegee par la pointe d"Arvert, la plage recoit une houle attenuee : ideal pour le longboard, le paddle et l"initiation.",
      tips: "Attention aux courants du coureau d"Oleron a maree descendante. Nombreuses cabanes ostreicoles a proximite pour finir la session.",
    },
    en: {
      teaser: "Facing the Oleron bridge, a sheltered beach for dawn paddles: the spot for calm sessions.",
      history: "Ronce-les-Bains was founded in 1860 as a health resort, when doctors praised the resinous air of the Coubre forest against tuberculosis. Seafront villas, a 1901 chapel and the old Royan tramway tell of that seaside Belle Epoque. Shielded by the Arvert point, the beach gets a softened swell: ideal for longboard, paddle and lessons.",
      tips: "Beware of currents in the Oleron channel on the ebb. Plenty of oyster huts nearby to end the session.",
    },
  ...
  },
  {
    ...
    facts: [
      ...
      { fr: "Marche sous le phare de Chassiron", en: "Below the Chassiron lighthouse" },
    ...
    fr: {
      ...
      history: "Le phare de Chassiron, allume en 1836 et raye de noir en 1926 pour être distingue de jour, veille sur la pointe nord d"Oleron. En contrebas s"etendent les ecluses a poissons, murets de pierre seche mediévaux qui piegeaient le poisson a maree descendante ; certaines sont encore entretenues. Le plateau rocheux qui les porte cree, par houle de nord-ouest, des vagues rapides et creuses reservees aux surfeurs aguerris.",
      tips: "Chaussons obligatoires, entree et sortie a l"eau delicates. Verifiez les coefficients : le spot est impraticable a basse mer.",
    },
    en: {
      teaser: "Beneath the black-and-white striped lighthouse, a spot with character: rock slabs, fish locks and serious waves.",
      history: "Chassiron lighthouse, lit in 1836 and painted with black stripes in 1926 to be recognisable by day, watches over Oleron"s northern tip. Below stretch the fish locks, medieval dry-stone walls that trapped fish on the ebb; some are still maintained. The rock platform they sit on creates fast, hollow waves on north-west swell, for experienced surfers only.",
  ...
  },
  {
    ...
    fr: {
      ...
      history: "Entre les Huttes et Chaucre s"etire un cordon dunaire classe, ou l"on trouve encore des cairns dresses par les promeneurs et les vestiges des cabanes de pecheurs qui donnerent leur nom a la plage. La foret des Saumonards et les dunes voisines furent plantees sous Napoleon III pour proteger les cultures de l"ensablement. Le fond de sable, remodele a chaque tempete, offre des pics differents d"une semaine a l"autre.",
      tips: "Surveillance estivale limitee a la plage des Huttes ; ailleurs, surfez accompagne. Prevoyez 5 a 10 min de marche depuis le parking.",
    },
    en: {
      teaser: "The northern Wild Coast: white dunes, shifting sandbars and swell almost every day.",
      history: "Between Les Huttes and Chaucre runs a protected dune belt, still dotted with walkers" cairns and traces of the fishermen"s huts that gave the beach its name. The nearby Saumonards forest and dunes were planted under Napoleon III to shield farmland from drifting sand. The sandy bottom, reshaped by every storm, offers different peaks week after week.",
