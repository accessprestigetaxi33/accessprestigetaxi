...
const DESC_FR ="Politique de confidentialité Access Prestige Taxi: données collectées, finalités, durée de conservation et droits RGPD.";
const DESC_EN ="Access Prestige Taxi privacy policy: data collected, purposes, retention periods and your GDPR rights.";
...
const COPY = {
 fr: {
 eyebrow:"RGPD"h1:"Politique de confidentialité"updated:"Dernière mise à jour"controller: {
 ...
 dataTitle:"Données collectées"dataItems: [
 ...
 purposeTitle:"Finalités"purposeItems: ["Traiter votre demande de réservation et vous contacter.""Assurer le suivi du véhicule en temps réel pendant votre trajet.""Améliorer la qualité du service (statistiques agrégées).""Respecter nos obligations légales (facturation, comptabilité)."],
 legalBasisTitle:"Base légale"legalBasisText:"Exécution du contrat de transport (article 6.1.b RGPD), consentement pour le suivi GPS et la mesure d'audience, et obligation légale pour la conservation comptable."retentionTitle:"Durée de conservation"retentionItems: ["Réservations actives\u00a0: 12 mois.""Données comptables\u00a0: 10 ans (obligation légale).""Position GPS\u00a0: supprimée à la fin de la course.""Messages de contact\u00a0: 24 mois."],
 recipientsTitle:"Destinataires"recipientsText: (
 <>
 ...
 rightsTitle:"Vos droits"rightsIntro:"Vous disposez des droits suivants\u00a0:"rightsItems: [
 ...
 cookiesTitle:"Cookies"cookiesText: (
 <>
 ...
 contactTitle:"Contact"contactText: (
 <>
 ...
 en: {
 eyebrow:"GDPR"h1:"Privacy Policy"updated:"Last updated"controller: {
 title:"Data controller"body: (
 <>
 ...
 dataTitle:"Data we collect"dataItems: [
 ...
 purposeTitle:"Purposes"purposeItems: ["Process your booking request and get in touch with you.""Track the vehicle in real time during your journey.""Improve service quality (aggregated statistics).""Comply with our legal obligations (invoicing, accounting)."],
 legalBasisTitle:"Legal basis"legalBasisText:"Performance of the transport contract (Article 6.1.b GDPR), consent for GPS tracking and audience measurement, and legal obligation for accounting records."retentionTitle:"Retention period"retentionItems: ["Active bookings: 12 months.""Accounting records: 10 years (legal obligation).""GPS location: deleted at the end of the ride.""Contact messages: 24 months."],
 recipientsTitle:"Recipients"recipientsText: (
 <>
 ...
 rightsTitle:"Your rights"rightsIntro:"You have the following rights:"rightsItems: [
