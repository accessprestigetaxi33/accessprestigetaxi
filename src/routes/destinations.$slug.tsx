...
const UI = {
 fr: {
 back:"Toutes les destinations"book:"Réserver ce trajet"call:"Appeler"distance:"Distance"duration:"Durée moyenne"price:"À partir de"quote:"Conventionné CPAM"included:"Ce qui est inclus"faq:"Questions fréquentes"other:"Autres trajets"safety:"Sécurité, assurance et garanties"},
 en: {
 back:"All destinations"book:"Book this ride"call:"Call"distance:"Distance"duration:"Average duration"price:"From"quote:"Health-service covered"included:"What's included"faq:"Frequently asked questions"other:"Other routes"safety:"Safety, insurance and guarantees"},
} as const;
...
function DestinationPage() {
 ...
 {"@type":"Service"name: c.h1,
 serviceType:"Taxi service"provider: {"@type":"TaxiService"name:"Access Prestige Taxi"areaServed: ["Charente-Maritime"],
 ...
 {"@type":"FAQPage"mainEntity: c.faq.map((f) => ({"@type":"Question"name: f.q,
