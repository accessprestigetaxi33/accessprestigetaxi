...
const CONTACT_DESC ="Contactez Access Prestige Taxi: 06 50 26 00 15, taxi.city033@gmail.com. Interventions en Charente-Maritime.";
...
export const Route = createFileRoute("/contact")({
 ...
 scripts: [
 {
 type:"application/ld+json"children: JSON.stringify({"@context":"https://schema.org""@type":"LocalBusiness"additionalType:"https://schema.org/TaxiService"name:"Access Prestige Taxi"slogan:"L'excellence à chaque trajet"url: CONTACT_URL,
 telephone: DRIVERS.map((d) => d.intl),
 email:"taxi.city033@gmail.com"areaServed: {"@type":"AdministrativeArea"name:"Charente-Maritime" },
...
const COPY = {
 fr: {
 whatsappTitle:"WhatsApp"whatsappHeadline:"Discutons sur WhatsApp"whatsappSub:"Messagerie instantanée"zoneTitle:"Zone d'intervention"zoneMain:"Charente-Maritime"zoneSub:"Tout le département (16 & 17)"zoneLong:"Longues distances sur toute la France et en Europe sur réservation."},
 en: {
 whatsappTitle:"WhatsApp"whatsappHeadline:"Chat with us on WhatsApp"whatsappSub:"Instant messaging"zoneTitle:"Service area"zoneMain:"Charente-Maritime"zoneSub:"The whole area (16 & 17)"zoneLong:"Long-distance trips throughout France and Europe by reservation."},
} as const;
