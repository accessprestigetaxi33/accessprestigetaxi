...
const DESC ="Nos trajets taxi les plus réservés en Charente-Maritime: gare TGV d'Angoulême, aéroport de Bordeaux, île de Ré, Royan, vignobles de Cognac et transport conventionné.";
...
export const Route = createFileRoute("/destinations/")({
 ...
 {"@type":"ItemList"itemListElement: DESTINATIONS.map((d, i) => ({"@type":"ListItem"position: i + 1,
 name: d.fr.h1,
...
const COPY = {
 fr: {
 eyebrow:"Destinations"h1:"Là où l'on vous emmène"lead:"Chaque trajet dispose de sa page dédiée: distance, durée, tarif de départ et conseils pratiques. Deux chauffeurs, une BMW iX1 électrique et un van Mercedes 7 places, zéro émission en Charente-Maritime."from:"À partir de"onQuote:"Sur prescription"see:"Voir le trajet"},
 en: {
 eyebrow:"Destinations"h1:"Where we take you"lead:"Every route has its own page: distance, duration, starting fare and practical tips. Two drivers, one electric BMW iX1 and one 7-seat Mercedes van, zero emissions across Charente-Maritime."from:"From"onQuote:"On prescription"see:"View this route"},
} as const;
