...
const PREMIUM_CSS = `
  * { box-sizing: border-box; }
  ...
  .suivi-step.done .suivi-step-dot, .suivi-step.active .suivi-step-dot { background:#07111b; color:#fff; border-color:#e0b866; }
  ...
  .suivi-gold-btn { display:flex; align-items:center; justify-content:center; gap:7px; min-height:38px; padding:8px 10px; border:1px solid #c99b4a; border-radius:7px; background:#050a10; color:#e0b866; text-decoration:none; font-size:10px; font-weight:900; }
            ...
            >
              <div
                style={{
                  background: "#0c1929",
                  color: "#fff",
                  border: mine ? "1px solid #e0b866" : "1px solid transparent",
                  padding: "8px 12px",
                  borderRadius: "10px",
                  fontSize: "13px",
      ...
      <div style={{ display: "flex", gap: "8px" }}>
        ...
        <button
          ...
          style={{
            ...
            minHeight: "44px",
            background: "#0d1a2b",
            color: sending || !text.trim() ? "#6b5a3a" : "#e0b866",
            border: "1px solid #c99b4a",
            borderRadius: "8px",
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
        ...
        <button
          ...
          style={{
            ...
            background: "#0d1a2b",
            color: "#fff",
            border: emailSent ? "1px solid #5fd08a" : "1px solid #e0b866",
            borderRadius: "10px",
            fontSize: "13px",
            fontWeight: 600,
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            background: "#0d1a2b",
            color: "#fff",
            border: saved ? "1px solid #5fd08a" : "1px solid #e0b866",
            borderRadius: 12,
            fontSize: 15,
            fontWeight: 800,
