...
const ALLOWED_ORIGINS = new Set(["https://accessprestigetaxi.lovable.app""https://www.accessprestigetaxi.lovable.app""https://cloud-launchpad-hug.lovable.app"]);
...
function corsFor(request: Request) {
 ...
 return {"Access-Control-Allow-Origin": allow"Access-Control-Allow-Methods":"POST, OPTIONS""Access-Control-Allow-Headers":"Content-Type, x-driver-key"Vary:"Origin"};
}
...
export const Route = createFileRoute("/api/public/driver-location")({
 ...
 {
 id:"driver"latitude: parsed.data.latitude,
