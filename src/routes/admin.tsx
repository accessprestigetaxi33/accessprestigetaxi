...
const STATUS_LABEL: Record<string, string> = {
 pending:"En attente"accepted:"Acceptée"en_route:"En route"arrived:"Sur place"completed:"Terminée"cancelled:"Annulée"};
...
function AdminPage() {
 ...
 <div
 style={{
 minHeight:"100dvh"display:"flex"alignItems:"center"justifyContent:"center"background: INK,
 color:"#fff"fontFamily:"DM Sans, sans-serif"padding: 24,
 }}
 >
 ...
 border:"1px solid #333"background:"#141416"color:"#fff"fontSize: 16,
 }}
 />
 <button
 type="submit"
...
function AdminDashboard({ token }: { token: string }) {
 ...
 [r.nom, r.client_name, r.telephone, r.depart, r.destination, r.arrivee, r.status, r.assigned_driver].filter(Boolean).some((v: string) => String(v).toLowerCase().includes(q)),
 );
 }, [data, query]);
 ...
 style={{
 background: INK,
 color:"#fff"padding:"16px 18px"display:"flex"alignItems:"center"justifyContent:"space-between"gap: 12,
 }}
 >
 <div>
 ...
 background: tab === t? INK:"#fff"color: tab === t? GOLD:"#334155"fontWeight: 700,
 fontSize: 14,
 whiteSpace:"nowrap"}}
 >
 ...
 border:"1px solid #eceef1"borderRadius: 12,
 padding:"12px 14px"}}
 >
 <div>
 ...
 minHeight: 44,
 background: d.active?"#fee2e2":"#dcfce7"color: d.active?"#b91c1c":"#15803d"}}
 >
 ...
 style={{
 border:"1px solid #d8dbe0"background: data.rotation.last_driver === d.id? INK:"#fff"color: data.rotation.last_driver === d.id? GOLD:"#334155"borderRadius: 10,
 padding:"10px 14px"fontWeight: 700,
 minHeight: 44,
 }}
 >
 ...
 padding: 14,
 boxShadow:"0 8px 24px rgba(0,0,0,0.25)"display:"flex"gap: 10,
 ...
 {e.event_type ==="created"?"Nouvelle course": e.event_type ==="assigned"?"Attribution":"Changement de statut"}
 {e.driver? ` · ${e.driver}`:""}
 </div>
