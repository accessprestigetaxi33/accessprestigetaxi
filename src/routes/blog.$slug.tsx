...
const COPY = {
  fr: {
    ...
    ctaText: "Nos deux chauteurs vous conduisent en BMW iX1 électrique ou van Mercedes 7 places, depuis Bordeaux et la Gironde.",
  ...
  en: {
    ...
    ctaText: "Our two drivers take you there in an electric BMW iX1 or a 7-seat Mercedes van, from Bordeaux and the Gironde.",
    book: "Book a ride",
    call: "Call a driver",
    stars: "stars",
  },
