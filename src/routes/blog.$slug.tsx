...
const COPY = {
 fr: {
 back:"Retour au guide"history:"L'histoire du lieu"tips:"Nos conseils"gallery:"En images"practical:"En bref"nearby:"À découvrir aussi"ctaTitle:"Trajet en taxi 100 % électrique"ctaText:"Nos deux chauteurs vous conduisent en BMW iX1 électrique ou van Mercedes 7 places, depuis Bordeaux et la Gironde."book:"Réserver ma course"call:"Appeler un chauffeur"stars:"étoiles"},
 en: {
 back:"Back to the guide"history:"The story of the place"tips:"Our tips"gallery:"In pictures"practical:"At a glance"nearby:"Also worth a look"ctaTitle:"Ride in a fully electric taxi"ctaText:"Our two drivers take you there in an electric BMW iX1 or a 7-seat Mercedes van, from Bordeaux and the Gironde."book:"Book a ride"call:"Call a driver"stars:"stars"},
} as const;
...
export const Route = createFileRoute("/blog/$slug")({
 ...
 {"@type":
 e.category ==="hotel"?"Hotel": e.category ==="restaurant"?"Restaurant":"TouristAttraction"name: e.name,
 description: e.fr.teaser,
 image: e.photos,
 address: {"@type":"PostalAddress"addressLocality: e.city,
 addressRegion:"Charente-Maritime"addressCountry:"FR"},...(e.stars? { starRating: {"@type":"Rating"ratingValue: e.stars } }: {}),
 },
 {"@type":"Article"headline: e.name,
 image: e.photos,
