...
const SERVICES_DESC ="Découvrez nos services de taxi en Charente-Maritime: transferts aéroport, gare, transport conventionné CPAM, mariages, business, longues distances.";
...
const SERVICES_FAQ = [
 {
 q:"Comment fonctionne le suivi en temps réel de mon vol ou de mon train?"a:"Dès que vous nous communiquez votre numéro de vol ou de train, nous le suivons automatiquement. Si l'arrivée est avancée ou retardée, l'heure de prise en charge est ajustée: vous n'avez rien à faire, le taxi sera là quand vous sortirez."},
 {
 q:"Combien de temps le taxi attend-il après l'atterrissage?"a:"Le taxi se présente après l'atterrissage réel (et non l'horaire prévu). Le temps nécessaire pour récupérer vos bagages et passer la douane est pris en compte. Au-delà, le temps d'attente supplémentaire est facturé au tarif réglementé en vigueur."},
 {
 q:"Comment se passe la prise en charge CPAM / ALD?"a:"Munissez-vous de la prescription médicale de transport remise par votre médecin. Sur présentation de ce bon de transport, nous appliquons le tiers payant: la course est directement prise en charge par l'Assurance Maladie. En ALD, la prise en charge est intégrale et valable pour toutes les distances."},
];
...
export const Route = createFileRoute("/services")({
 ...
 {"@type":"FAQPage"mainEntity: SERVICES_FAQ.map((f) => ({"@type":"Question"name: f.q,
 acceptedAnswer: {"@type":"Answer"text: f.a },
 })),
 },
 {"@type":"ItemList"itemListElement: SERVICE_LIST.map((svc, i) => ({"@type":"ListItem"position: i + 1,
