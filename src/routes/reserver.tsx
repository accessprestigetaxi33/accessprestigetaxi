...
function ReservationPage() {
 ...
 m.role ==="user"?"rounded-br-sm bg-[#C6A24A] text-[#0B0B0D]":"rounded-bl-sm border border-[#F4F1EA]/10 bg-[#161618] text-[#F4F1EA]"
 }`}
 >
 ...
 recording?"border-red-400 bg-red-400/20 text-red-400":"border-[#C6A24A]/30 text-[#C6A24A] hover:bg-[#C6A24A]/10"
 }`}
...
function WelcomeBubble({ t, lang }: { t: (k: string) => string; lang: string }) {
 ...
 {lang ==="en"?"Examples: \"La Rochelle to Royan tomorrow at 2pm for 2 people\" or \"Airport pickup on Monday at 9am\".":"Exemples: \"La Rochelle vers Royan demain à 14h pour 2 personnes\" ou \"Récupération à l'aéroport lundi à 9h\"."}
 </p>
 </div>
 </div>
 );
