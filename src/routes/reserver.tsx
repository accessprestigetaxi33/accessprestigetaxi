...
export const Route = createFileRoute("/reserver")({
  validateSearch: (search: Record<string, unknown>): { lang?: "en" | "fr"; from?: string; to?: string } => ({
...
function ReserverPage() {
  ...
  return (
    <>
      <SocialMetaSync lang={lang === "en" ? "en" : "fr"} fr={RESERVER_SOCIAL_FR} en={RESERVER_SOCIAL_EN} />
      <BookingStudio />
    </>
  );
}
