...
const ABOUT_DESC ="Access Prestige Taxi: deux chauffeurs, Patricia et Alain, un service de taxi premium 100 % électrique en Charente-Maritime.";
...
export const Route = createFileRoute("/a-propos")({
 ...
 scripts: [
 {
 type:"application/ld+json"children: JSON.stringify({"@context":"https://schema.org""@type":"LocalBusiness"additionalType:"https://schema.org/TaxiService"name:"Access Prestige Taxi"slogan:"L'excellence à chaque trajet"url: ABOUT_URL,
