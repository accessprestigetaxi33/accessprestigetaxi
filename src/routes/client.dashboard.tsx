...
function ClientDashboard() {
  ...
  const unreadMessages = useClientUnreadMessages();
          ...
          <div className="cd-main-inner">
            <div className="cd-mobile-shell">
              ...
              <div className="cd-section">
                <ClientMessagesCard clientToken={session?.token ?? ""} />
              </div>
              <div className="cd-section">
                <ClientPushOptInCard
              ...
              <nav className="cd-quick" aria-label={c.eyebrow}>
                ...
                <Link to="/client/chat" className="cd-quick-msg">
                  <MessageCircle size={18} />
                  <span>{c.messages}</span>
                  {unreadMessages > 0 && (
                    <span className="cd-quick-badge">{unreadMessages > 9 ? "9+" : unreadMessages}</span>
                  )}
                </Link>
