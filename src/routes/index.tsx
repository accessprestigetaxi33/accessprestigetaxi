...
const CARD ="rounded-2xl border border-border bg-card transition duration-300 hover:-translate-y-1 hover:border-primary/60 hover:shadow-[0_18px_40px_-18px_color-mix(in_oklab,var(--gold)_55%,transparent)]";
...
const heroSlides = (lang:"fr" |"en") => {
 ...
 return [
 {
 id:"brand"src: en? heroCarsEn.url: heroCars.url,
 alt: en?"Access Prestige Taxi — BMW iX1 electric and Mercedes V-Class van, excellence on every journey, Charente-Maritime":"Access Prestige Taxi — BMW iX1 électrique et van Mercedes V-Class, l'excellence à chaque trajet, Charente-Maritime"label: en?"Our fleet":"Notre flotte"title: en?"Excellence on every journey":"L'excellence à chaque trajet"desc: en?"Two drivers, three premium vehicles across Charente-Maritime.":"Deux chauffeurs, trois véhicules haut de gamme en Charente-Maritime."specs: en? ["2 drivers""""Charente-Maritime"]: ["2 chauffeurs""""Charente-Maritime"],
 // Bannière de marque complète: logo, slogan et services doivent rester lisibles.
 contain: true,
 pan: { x: 0, y: 0 },
 },
 {
 id:"bmw"src: photoExterior.url,
 alt: en?"BMW iX1 100% electric taxi driven by Patricia, Access Prestige Taxi in Charente-Maritime":"Taxi BMW iX1 100 % électrique conduit par Patricia, Access Prestige Taxi en Charente-Maritime"label:"BMW iX1 · Patricia"title: en?"BMW iX1 — 100% electric":"BMW iX1 — 100 % électrique"desc: en?"Silent, zero-emission rides for airport transfers, medical trips and daily journeys, up to 4 passengers.":"Trajets silencieux et zéro émission pour transferts aéroport, courses médicales et déplacements du quotidien, jusqu'à 4 passagers."specs: en? ["4 passengers""Zero emission""Child seats"]: ["4 passagers""Zéro émission""Sièges enfants"],
 pan: { x: 18, y: 6 },
 },
 {
 id:"audi"src: photoAudi,
 alt: en?"Audi Q6 e-tron, 100% electric premium SUV for business transfers, Access Prestige Taxi":"Audi Q6 e-tron, SUV premium 100 % électrique pour transferts affaires, Access Prestige Taxi"label:"Audi Q6 e-tron"title: en?"Audi Q6 e-tron — premium SUV":"Audi Q6 e-tron — SUV premium"desc: en?"Our electric flagship for business travel and long-distance transfers: generous space, deep comfort, total discretion.":"Notre vaisseau amiral électrique pour les déplacements professionnels et les longues distances: espace généreux, confort profond, discrétion totale."specs: en? ["Business""Long distance""100% electric"]: ["Affaires""Longue distance""100 % électrique"],
 pan: { x: -16, y: -8 },
 },
 {
 id:"van"src: photoVan.url,
 alt: en?"Mercedes V-Class 7-seat van driven by Alain for group transport, Access Prestige Taxi":"Van Mercedes V-Class 7 places conduit par Alain pour le transport de groupe, Access Prestige Taxi"label:"Mercedes Van · Alain"title: en?"Mercedes van — up to 7 seats":"Van Mercedes — jusqu'à 7 places"desc: en?"Family, team or wedding: seven passengers plus luggage in one trip, at one single fare.":"Famille, équipe ou mariage: sept passagers et leurs bagages en un seul trajet, à un seul tarif."specs: en? ["7 passengers""Luggage""Single fare"]: ["7 passagers""Bagages""Tarif unique"],
 pan: { x: 16, y: -10 },
 },
 {
 id:"driver"src: photoDriver.url,
 alt: en?"Access Prestige Taxi licensed driver at the wheel in Charente-Maritime":"Chauffeur de taxi agréé Access Prestige Taxi au volant en Charente-Maritime"label: en?"Our drivers":"Nos chauffeurs"title: en?"Patricia & Alain at your service":"Patricia & Alain à votre service"desc: en?"Licensed taxi drivers, punctual and discreet, with real-time tracking on every booking.":"Chauffeurs de taxi agréés, ponctuels et discrets, avec suivi en temps réel sur chaque réservation."specs: en? ["Licensed""Real-time tracking""Discretion"]: ["Agréés""Suivi temps réel""Discrétion"],
 pan: { x: -14, y: 10 },
 },
 ];
};
...
const COPY = {
 fr: {
 kicker:"100 % électrique · Charente-Maritime"tagline: SLOGAN_FR,
 lead:"Deux chauffeurs, une BMW iX1 100 % électrique et un van Mercedes 7 places. Un service de taxi haut de gamme, silencieux et attentionné."ctaBook:"Réserver ma course"ctaCall:"Appeler"callPrefix:"Appeler"driversEyebrow:"Nos deux chauffeurs"driversTitle:"Patricia & Alain, à votre service"driversLead:"Deux chauffeurs indépendants, une même exigence: ponctualité, discrétion et confort, en Charente-Maritime."stats: [
 { n: 2, suffix:""l:"chauffeurs dédiés" },
 { n: 100, suffix:" %"l:"électrique (BMW iX1)" },
 { n: 7, suffix:" places"l:"van Mercedes" },
 ],
 servicesEyebrow:"Nos services"servicesTitle:"Une prestation pensée pour chaque trajet"services: [
 { photo: photoMedical, t:"Transport conventionné"d:"Trajets médicaux assis, prise en charge simplifiée." },
 {
 photo: photoInterior.url,
 t:"Confort intérieur"d:"Habitacle soigné, silence électrique, eau et chargeurs à bord."},
 { photo: photoAirport, t:"Gares & aéroports"d:"Suivi des vols et des trains, accueil en gare." },
 {
 photo: photoDriver.url,
 t:"Chauffeurs agréés"d:"Patricia et Alain, chauffeurs de taxi conventionnés en Charente-Maritime."},
 { photo: photoBusiness, t:"Déplacements professionnels"d:"Ponctualité, discrétion, facture entreprise." },
 {
 photo: photoExterior.url,
 t:""d:"Réservation immédiate ou planifiée,."},
 ],
 seatsEyebrow:"Familles"seatsTitle:"Sièges bébé et rehausseurs enfants, sur demande"seatsText:"Nous embarquons gratuitement un siège bébé (0-13 kg), un siège enfant ou un rehausseur: précisez-le simplement au moment de la réservation rapide, nous préparons le véhicule avant votre départ."seatsItems: ["Siège bébé (0-13 kg)""Siège enfant (9-18 kg)""Rehausseur (15-36 kg)"],
 seatsCta:"Choisir mon siège à la réservation"groupEyebrow:"Transport de groupe"groupTitle:"Jusqu'à 7 personnes dans le van Mercedes"groupText:"Famille, équipe, mariage, sortie entre amis ou transfert aéroport à plusieurs: le van Mercedes d'Alain accueille jusqu'à 7 passagers avec leurs bagages, en un seul trajet et à un seul tarif."groupBullets: ["7 passagers + bagages""Un seul tarif, un seul véhicule""Mise à disposition à l'heure"],
 groupCta:"Réserver le van 7 places"whyEyebrow:"Pourquoi nous"whyTitle:"L'élégance électrique, sans compromis"why: [
 {
 photo: photoExterior.url,
 t:"Zéro émission"d:"La BMW iX1 de Patricia roule 100 % à l'électrique, sans bruit ni vibration."},
 {
 photo: photoDriver.url,
 t:"Deux chauffeurs, un standard"d:"Même exigence de confort, de discrétion et de ponctualité."},
 { photo: photoPrice, t:"Prix annoncé, prix tenu"d:"Estimation transparente avant le départ." },
 ],
 bannerTitle:"La Charente-Maritime, d'un point à l'autre"bannerText:"La Rochelle, Rochefort, Royan, Saintes, Île de Ré et Oléron — nous vous y conduisons."destEyebrow:"Destinations"destTitle:"Là où l'on vous emmène"destLead:"Quelques itinéraires que nos clients réservent au quotidien: l'arrivée en douceur, c'est notre métier."destinations: [
 ...
 bestEyebrow:"Les best-sellers"bestTitle:"Nos courses les plus demandées"best: [
 {
 n:"01"img: photoGare,
 t:"Transferts gare & aéroport"d:"Accueil pancarte, suivi du train ou du vol, bagages pris en charge."},
 {
 n:"02"img: photoMedical,
 t:"Trajets médicaux conventionnés"d:"Dialyse, chimiothérapie, consultations: prise en charge simplifiée."},
 {
 n:"03"img: photoVan.url,
 t:"Groupes jusqu'à 7 personnes"d:"Van Mercedes, bagages inclus, un seul véhicule pour tout le monde."},
 ],
 howEyebrow:"Comment ça marche"howTitle:"Trois étapes, une minute"how: [
 {
 s:"1"img: photoStepVoice,
 t:"Vous décrivez le trajet"d:"À la voix ou à l'écrit: départ, arrivée, date, heure et siège enfant."},
 {
 s:"2"img: photoStepConfirm,
 t:"Nous confirmons"d:"Prix annoncé et chauffeur assigné, confirmation par e-mail."},
 {
 s:"3"img: photoStepTrack,
 t:"Vous suivez la course"d:"Lien de suivi en temps réel, puis reçu détaillé à l'arrivée."},
 ],
 clientEyebrow:"Espace client"clientTitle:"Vos courses, vos factures, au même endroit"clientText:"Créez votre espace pour retrouver l'historique de vos trajets, télécharger vos factures, enregistrer vos adresses favorites et programmer vos courses récurrentes."clientCta:"Accéder à l'espace client"reviewEyebrow:"Vos avis"reviewTitle:"Déposez votre avis"reviewText:"Votre retour aide Patricia et Alain à faire encore mieux. Merci pour votre confiance."blogEyebrow:"Le blog"blogTitle:"Guide Charente-Maritime"blogText:"Restaurants, hôtels, randonnées et lieux à visiter — repérés par vos chauffeurs."blogCta:"Voir tout le guide"ctaTitle:"Prêt à réserver votre course?"ctaText:"Réservation en moins d'une minute, à la voix ou à l'écrit."},
 en: {
 kicker:"100% electric · Charente-Maritime"tagline: SLOGAN_EN,
 lead:"Two drivers, one fully electric BMW iX1 and one 7-seat Mercedes van. A premium, silent and attentive taxi service."ctaBook:"Book a ride"ctaCall:"Call"callPrefix:"Call"driversEyebrow:"Our two drivers"driversTitle:"Patricia & Alain, at your service"driversLead:"Two independent drivers, one shared standard: punctuality, discretion and comfort across Charente-Maritime."stats: [
 { n: 2, suffix:""l:"dedicated drivers" },
 { n: 100, suffix:"%"l:"electric (BMW iX1)" },
 { n: 7, suffix:" seats"l:"Mercedes van" },
 ],
 servicesEyebrow:"Our services"servicesTitle:"A service designed for every journey"services: [
 { photo: photoMedical, t:"Medical transport"d:"Seated medical trips with simplified coverage." },
 {
 photo: photoInterior.url,
 t:"Interior comfort"d:"Immaculate cabin, electric silence, water and chargers on board."},
 { photo: photoAirport, t:"Stations & airports"d:"Flight and train tracking, meet & greet." },
 {
 photo: photoDriver.url,
 t:"Licensed drivers"d:"Patricia and Alain, licensed taxi drivers in Charente-Maritime."},
 { photo: photoBusiness, t:"Business travel"d:"Punctual, discreet, company invoicing." },
 {
 photo: photoExterior.url,
 t:""d:"Instant or scheduled booking,."},
 ],
 seatsEyebrow:"Families"seatsTitle:"Baby seats and child boosters, on request"seatsText:"We carry a baby seat (0-13 kg), a child seat or a booster free of charge: just pick the seat type in the quick booking form and we fit it before pickup."seatsItems: ["Baby seat (0-13 kg)""Child seat (9-18 kg)""Booster (15-36 kg)"],
 seatsCta:"Pick my seat when booking"groupEyebrow:"Group transport"groupTitle:"Up to 7 people in the Mercedes van"groupText:"Family, team, wedding, night out or a group airport transfer: Alain's Mercedes van seats up to 7 passengers with their luggage — one ride, one fare."groupBullets: ["7 passengers + luggage""One fare, one vehicle""Hourly hire available"],
 groupCta:"Book the 7-seat van"whyEyebrow:"Why us"whyTitle:"Electric elegance, no compromise"why: [
 {
 photo: photoExterior.url,
 t:"Zero emissions"d:"Patricia's BMW iX1 is fully electric — no noise, no vibration."},
 {
 photo: photoDriver.url,
 t:"Two drivers, one standard"d:"The same demand for comfort, discretion and punctuality."},
 { photo: photoPrice, t:"Quoted price, final price"d:"Transparent estimate before departure." },
 ],
 bannerTitle:"Charente-Maritime, door to door"bannerText:"La Rochelle, Rochefort, Royan, Saintes, Île de Ré and Oléron — we drive you there."destEyebrow:"Destinations"destTitle:"Where we take you"destLead:"A few routes our clients book every day — arriving smoothly is our job."destinations: [
 ...
 bestEyebrow:"Best-sellers"bestTitle:"Our most requested rides"best: [
 {
 n:"01"img: photoGare,
 t:"Station & airport transfers"d:"Meet & greet, train or flight tracking, luggage handled."},
 {
 n:"02"img: photoMedical,
 t:"Covered medical trips"d:"Dialysis, chemotherapy, appointments: simplified coverage."},
 {
 n:"03"img: photoVan.url,
 t:"Groups of up to 7"d:"Mercedes van, luggage included, one vehicle for everyone."},
 ],
 howEyebrow:"How it works"howTitle:"Three steps, one minute"how: [
 {
 s:"1"img: photoStepVoice,
 t:"Describe your ride"d:"By voice or typing: pickup, drop-off, date, time and child seat."},
 {
 s:"2"img: photoStepConfirm,
 t:"We confirm"d:"Quoted price and assigned driver, confirmed by email."},
 {
 s:"3"img: photoStepTrack,
 t:"Track your ride"d:"Live tracking link, then a detailed receipt on arrival."},
 ],
 clientEyebrow:"Client area"clientTitle:"Your rides and invoices in one place"clientText:"Create your account to find your ride history, download invoices, save favourite addresses and schedule recurring rides."clientCta:"Go to the client area"reviewEyebrow:"Your reviews"reviewTitle:"Leave a review"reviewText:"Your feedback helps Patricia and Alain do even better. Thank you for your trust."blogEyebrow:"The blog"blogTitle:"Charente-Maritime guide"blogText:"Restaurants, hotels, hikes and places to visit — picked by your drivers."blogCta:"See the full guide"ctaTitle:"Ready to book your ride?"ctaText:"Book in under a minute, by voice or by typing."},
} as const;
...
export const Route = createFileRoute("/")({
 ...
 {
 name:"description"content:"Taxi haut de gamme 100 % électrique en Charente-Maritime. Deux chauffeurs, BMW iX1 électrique et van Mercedes 7 places, sièges bébé et enfants, transport conventionné, gares & aéroports."},
 { property:"og:title"content:"Access Prestige Taxi — L'excellence à chaque trajet" },
 {
 property:"og:description"content:"L'excellence à chaque trajet: réservation rapide vocale ou écrite, BMW iX1 100 % électrique et van Mercedes 7 places en Charente-Maritime."},
 ...
 {
 property:"og:image:alt"content:"Access Prestige Taxi — BMW iX1, Audi Q6 et van Mercedes V-Class, transport transferts déplacements 100% électrique"},
 ...
 {
 name:"twitter:description"content:"Taxi haut de gamme 100 % électrique en Charente-Maritime. Réservation en moins d'une minute."},
 { name:"twitter:image"content: absoluteUrl(heroCars.url) },
 ],
 links: seoLinks("/"),
 scripts: [
 {
 type:"application/ld+json"children: JSON.stringify({"@context":"https://schema.org""@type":"TaxiService"name:"Access Prestige Taxi"slogan: SLOGAN_FR,
 url: SITE_URL,
 ...
 openingHours:"Mo-Fr"// TODO: ajuste selon ta tarification réelle (€, €€, €€€)
 priceRange:"€€"// TODO: ajoute tes profils réels (Google Business, Facebook, Instagram...) —
 // utile pour relier ta fiche Google Business à ce site.
 // sameAs: ["https://www.google.com/maps/place/...""https://www.facebook.com/..."],
 employee: DRIVERS.map((d) => ({"@type":"Person"name: d.name,
 jobTitle:"Chauffeur de taxi"telephone: d.intl,
 })),
 contactPoint: DRIVERS.map((d) => ({"@type":"ContactPoint"name: d.name,
 telephone: d.intl,
 contactType:"reservations"areaServed: ["Charente-Maritime"],
 availableLanguage: ["fr""en"],
 })),
 ...
 // aggregateRating: {
 //"@type":"AggregateRating"// ratingValue: realAverageRating,
 // reviewCount: realReviewCount,
 // },
 }),
 },
 {
 type:"application/ld+json"children: JSON.stringify({"@context":"https://schema.org""@type":"ItemList"name:"L'excellence à chaque trajet — flotte Access Prestige Taxi"alternateName:"Excellence on every journey — Access Prestige Taxi fleet"itemListElement: [
 {"@type":"Car"position: 1,
 name:"BMW iX1 100 % électrique"alternateName:"BMW iX1 100% electric"image: absoluteUrl(photoExterior.url),
 vehicleSeatingCapacity: 4,
 fuelType:"Electric"description:"Taxi BMW iX1 100 % électrique conduit par Patricia: transferts aéroport, courses médicales et déplacements du quotidien en Charente-Maritime."},
 {"@type":"Car"position: 2,
 name:"Audi Q6 e-tron"image: absoluteUrl(photoAudi),
 vehicleSeatingCapacity: 4,
 fuelType:"Electric"description:"SUV premium 100 % électrique pour déplacements professionnels et longues distances en Charente-Maritime."},
 {"@type":"Car"position: 3,
 name:"Van Mercedes V-Class 7 places"alternateName:"Mercedes V-Class 7-seat van"image: absoluteUrl(photoVan.url),
 vehicleSeatingCapacity: 7,
 description:"Van Mercedes conduit par Alain: transport de groupe jusqu'à 7 passagers avec bagages, tarif unique."},
 ],
 }),
 },
 ],
...
function Index() {
 ...
 height={768}
 className={
 isBanner?"h-full w-full object-contain object-center":"h-full w-full object-cover object-center"
 }
 initial={isBanner? { opacity: 1, scale: 1 }: { scale: 1.06, x: 0, y: 0 }}
 animate={
 isBanner? { scale: 1, x: 0, y: 0 }: canAnimate? { scale: 1.16, x: slide.pan.x, y: slide.pan.y }: { scale: 1.06, x: 0, y: 0 }
 }
 ...
 <div
 className={
 isBanner?"absolute inset-0 -z-10 bg-[linear-gradient(180deg,transparent_0%,transparent_80%,var(--background)_100%)]":"absolute inset-0 -z-10 bg-[linear-gradient(180deg,rgba(8,8,10,0.15)_0%,rgba(8,8,10,0.35)_60%,var(--background)_100%)]"
 }
 />
 </>
 );
 ...
 {lang ==="en"?"Excellence on every journey — our electric taxi fleet in Charente-Maritime":"L'excellence à chaque trajet — notre flotte de taxis électriques en Charente-Maritime"}
 </h2>
 ...
 i === slideIndex?"border-primary shadow-[var(--shadow-gold)]":"border-border opacity-70 hover:opacity-100"
 }`}
 >
 <img
 src={s.src}
 ...
 {lang ==="en"?"Our premium fully electric SUV, available on request for business transfers, airport runs and long distances: silent cabin, generous luggage space and extended range across Charente-Maritime.":"Notre SUV haut de gamme 100 % électrique, disponible sur demande pour les transferts affaires, les aéroports et les longues distances: habitacle silencieux, coffre généreux et grande autonomie en Charente-Maritime."}
 </p>
 </div>
 </article>
 </Reveal>
