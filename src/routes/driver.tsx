 ...
 * { -webkit-tap-highlight-color: transparent; box-sizing: border-box; touch-action: manipulation; }
 ...
 input, textarea, select { font-size: 16px; }.drv-root {
 ...
 flex-shrink: 0;
 }.drv-header h1 { margin: 0; font-size: 17px; font-weight: 700; flex: 1; font-family:'DM Sans'sans-serif; }.drv-tabs {
 ...
 }.drv-tab:active { background: #f8fafc; }.drv-tab.active { color: #0f172a; border-bottom-color: #0f172a; }.drv-tab svg { width: 22px; height: 22px; }.drv-badge { background: #ef4444; color: #fff; border-radius: 99px; font-size: 10px; font-weight: 700; padding: 1px 5px; position: absolute; top: -3px; right: -5px; }.drv-body {
 flex: 1; padding: 16px;
 padding-bottom: calc(env(safe-area-inset-bottom, 0px) + 24px);
 overflow-y: auto; -webkit-overflow-scrolling: touch; overscroll-behavior-y: contain;
 }.drv-section { font-size: 10px; font-weight: 700; color: #94a3b8; letter-spacing: 0.08em; text-transform: uppercase; margin: 0 0 10px; }.drv-card { background: #fff; border: 1px solid #e2e8f0; border-radius: 16px; padding: 14px; margin-bottom: 10px; }.drv-card.pending { border-color: #f59e0b; }.drv-card.new { border-color: #3b82f6; box-shadow: 0 0 0 3px #3b82f620; }.drv-card.done { opacity: 0.5; }.drv-card.accepted { border-color: #22c55e; }.drv-card.refused { border-color: #ef4444; opacity: 0.6; }.drv-row { display: flex; align-items: center; justify-content: space-between; margin-bottom: 6px; }.drv-time { font-size: 22px; font-weight: 800; color: #0f172a; }.drv-name { font-size: 14px; font-weight: 600; color: #0f172a; }.drv-sub { font-size: 12px; color: #64748b; }.drv-route { display: flex; flex-direction: column; gap: 4px; margin: 8px 0; }.drv-route span { display: flex; align-items: flex-start; gap: 6px; font-size: 13px; color: #334155; line-height: 1.4; }.drv-meta { display: flex; gap: 12px; font-size: 12px; color: #64748b; margin: 8px 0 12px; flex-wrap: wrap; }.drv-meta span { display: flex; align-items: center; gap: 4px; }.drv-btns { display: flex; gap: 8px; }.drv-btn-primary { flex: 1; min-height: 46px; background: #0f172a; color: #fff; border: none; border-radius: 12px; padding: 12px; font-size: 14px; font-weight: 700; font-family:'DM Sans'sans-serif; cursor: pointer; }.drv-btn-primary:active { background: #1e293b; }.drv-btn-secondary { flex: 1; min-height: 46px; background: #f1f5f9; color: #0f172a; border: 1px solid #e2e8f0; border-radius: 12px; padding: 12px; font-size: 14px; font-weight: 600; font-family:'DM Sans'sans-serif; cursor: pointer; }.drv-btn-secondary:active { background: #e2e8f0; }.drv-btn-danger { flex: 1; min-height: 46px; background: #fef2f2; color: #dc2626; border: 1px solid #fecaca; border-radius: 12px; padding: 12px; font-size: 14px; font-weight: 600; font-family:'DM Sans'sans-serif; cursor: pointer; }.drv-btn-danger:active { background: #fee2e2; }.drv-badge-pill { font-size: 11px; font-weight: 600; padding: 3px 9px; border-radius: 99px; }.drv-badge-blue { background: #eff6ff; color: #1d4ed8; }.drv-badge-green { background: #f0fdf4; color: #15803d; }.drv-badge-amber { background: #fffbeb; color: #92400e; }.drv-badge-red { background: #fef2f2; color: #b91c1c; }.drv-badge-gray { background: #f1f5f9; color: #475569; }.drv-stars { color: #f59e0b; font-size: 15px; letter-spacing: 1px; }.drv-stars-empty { color: #cbd5e1; font-size: 15px; }.drv-stat-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 14px; }.drv-stat { background: #f8fafc; border-radius: 14px; padding: 14px; }.drv-stat-lbl { font-size: 11px; color: #64748b; margin-bottom: 4px; }.drv-stat-val { font-size: 24px; font-weight: 800; color: #0f172a; }.drv-stat-sub { font-size: 11px; color: #94a3b8; margin-top: 2px; }.drv-empty { text-align: center; padding: 50px 20px; color: #94a3b8; }.drv-empty svg { width: 40px; height: 40px; margin-bottom: 10px; opacity: 0.4; }.drv-route-opt { border: 1.5px solid #e2e8f0; border-radius: 14px; padding: 12px 14px; margin-bottom: 10px; cursor: pointer; transition: border-color 0.15s; min-height: 44px; }.drv-route-opt:active { background: #f8fafc; }.drv-route-opt.selected { border-color: #0f172a; background: #f8fafc; }.drv-route-opt-head { display: flex; align-items: center; justify-content: space-between; margin-bottom: 6px; }.drv-route-label { font-size: 13px; font-weight: 700; color: #0f172a; }.drv-route-price { font-size: 16px; font-weight: 800; color: #0f172a; }.drv-route-meta { display: flex; gap: 10px; font-size: 12px; color: #64748b; }.drv-map { width: 100%; height: 200px; border-radius: 12px; overflow: hidden; margin-bottom: 14px; border: 1px solid #e2e8f0; touch-action: pan-x pan-y; }.drv-divider { border: none; border-top: 1px solid #f1f5f9; margin: 16px 0; }.drv-planning-slot { display: flex; gap: 10px; align-items: flex-start; margin-bottom: 12px; }.drv-planning-time { font-size: 12px; color: #64748b; min-width: 40px; padding-top: 3px; }.drv-planning-dot { width: 10px; height: 10px; border-radius: 50%; margin-top: 4px; flex-shrink: 0; }.drv-planning-card { flex: 1; background: #fff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 10px 12px; }
 @media (max-width: 380px) {.drv-time { font-size: 18px; }.drv-stat-val { font-size: 20px; }
 }.drv-chat-thread { border: 1px solid #e2e8f0; border-radius: 14px; padding: 12px 14px; margin-bottom: 8px; cursor: pointer; background: #fff; display: flex; align-items: center; gap: 10; }.drv-chat-thread:active { background: #f8fafc; }.drv-chat-thread.unread { border-color: #3b82f6; background: #eff6ff; }.drv-chat-avatar { width: 38px; height: 38px; border-radius: 50%; background: #0f172a; color: #fff; display: flex; align-items: center; justify-content: center; font-size: 15px; font-weight: 700; flex-shrink: 0; }.drv-chat-bubble { max-width: 78%; border-radius: 14px; padding: 9px 12px; font-size: 13.5px; line-height: 1.45; }.drv-chat-bubble.me { background: #0f172a; color: #fff; border-radius: 14px 14px 4px 14px; margin-left: auto; }.drv-chat-bubble.them { background: #f1f5f9; color: #0f172a; border-radius: 14px 14px 14px 4px; }
 @keyframes drv-fadein { from { opacity:0; transform:translateY(5px); } to { opacity:1; transform:none; } }.drv-msg-in { animation: drv-fadein 0.25s ease both; }
 @keyframes drv-pulse { 0%, 100% { opacity:1; box-shadow: 0 0 0 3px rgba(34,197,94,0.3); } 50% { opacity:0.6; box-shadow: 0 0 0 6px rgba(34,197,94,0.1); } }.drv-visitor-dot-active { animation: drv-pulse 2s ease-in-out infinite; }
`;
...
function DriverPage() {
 ...
 <div
 style={{
 display:"flex"alignItems:"center"justifyContent:"center"height:"100dvh"fontFamily:"DM Sans,sans-serif"color:"#64748b"padding: 24,
 }}
 >
 ...
 style={{
 padding:"12px 14px"borderRadius: 10,
 border:"none"background:"#0B0B0D"color:"#C6A24A"fontWeight: 700,
 fontSize: 15,
 cursor:"pointer"}}
 >
 Se connecter
...
function DriverApp({ driverLabel, driverId }: { driverLabel?: string; driverId?: string }) {
 ...
 load();
 const ch = (supabase as any).channel("drv-avis-badge").on("postgres_changes"{ event:"INSERT"schema:"public"table:"avis" }, (payload: any) => {
 ...
 load();
 }).on("postgres_changes"{ event:"UPDATE"schema:"public"table:"avis" }, load).on("postgres_changes"{ event:"DELETE"schema:"public"table:"avis" }, load).subscribe();
 ...
 textDecoration:"none"border:"1px solid #334155"borderRadius: 8,
 ...
 background: pushStatus ==="denied"?"#fef2f2": pushStatus ==="granted"?"#f0fdf4":"#eff6ff"borderBottom:"1px solid #e2e8f0"padding:"10px 16px"fontSize: 12.5,
 color: pushStatus ==="denied"?"#b91c1c": pushStatus ==="granted"?"#15803d":"#1d4ed8"}}
 >
 <span>
 {pushStatus ==="denied"?"🔕 Notifications bloquées — active-les dans les réglages.": pushStatus ==="granted"?"🔔 Notifications actives":"🔔 Active les notifications pour ne rater aucune nouvelle course."}
 </span>
 {pushStatus!=="denied" && (
 <button
 ...
 {
 {
 courses:"Course + chat client"planning:"Planning"avis:"Avis"clients:"Clients"stats:"Stats"historique:"Historique"simulateur:"Simu"}[t]
 }
 </span>
 </button>
 ))}
...
function CoursesTab({
 ...
 const feed = (supabase as any).channel("driver-feed"{ config: { broadcast: { self: false } } }).on("broadcast"{ event:"reservation" }, () => scheduleLoad(true)).subscribe();
 ...
 const ch = (supabase as any).channel(`drv-courses-${visibleIds.length}`).on("postgres_changes"{ event:"*"schema:"public"table:"reservations"filter: `id=in.(${visibleIds.join("")})` },
 () => scheduleLoad(),
 )
 // INSERT reservations (nouvelle course) → refresh liste complète.on("postgres_changes"{ event:"INSERT"schema:"public"table:"reservations" }, () => scheduleLoad())
 // INSERT message client sur une résa visible → increment ciblé du badge.on("postgres_changes"{ event:"INSERT"schema:"public"table:"reservation_messages"filter: idFilter },
 (payload: any) => {
 const row = payload?.new;
 ...
 if (q) {
 const hay = [r.depart, r.destination, (r as any).arrivee, r.client_name, (r as any).client_phone].filter(Boolean).join("").toLowerCase();
 ...
 const encours = visible.filter((r) => r.status ==="accepted" || r.status ==="en_route" || r.status ==="arrived").sort(sortByPriority);
 const followups = visible.filter((r) =>!["pending""accepted""en_route""arrived"].includes(r.status)).sort(sortByPriority);

 const chip = (active: boolean): React.CSSProperties => ({
 padding:"7px 12px"borderRadius: 999,
 border:"1px solid" + (active?"#0B0B0D":"#cbd5e1"),
 background: active?"#0B0B0D":"#fff"color: active?"#C6A24A":"#334155"fontSize: 12,
 fontWeight: 700,
 ...
 background: assigned ==="patricia"?"#fdf2f8":"#eff6ff"color: assigned ==="patricia"?"#9d174d":"#1d4ed8"border:"1px solid" + (assigned ==="patricia"?"#fbcfe8":"#bfdbfe"),
 }}
 >
...
function CourseCard({
 ...
 const unreadTooltip =
 unreadCount > 0? `${unreadCount} message${unreadCount > 1?"s":""} client non lu${unreadCount > 1?"s":""} · ${unreadContext}`:"Aucun message non lu";
 ...
 const waypointLatLng = midStep?.start_location? { lat: midStep.start_location.lat(), lng: midStep.start_location.lng() }: null;
 ...
 (route.overview_polyline as unknown as string)??""dirResult: {...result, routes: [route] },
 ...
 gestureHandling:"cooperative"styles: [{ featureType:"poi"stylers: [{ visibility:"off" }] }],
 });
 }
 ...
 method:"POST"headers: {"Content-Type":"application/json""X-Admin-Secret":"admin-pin-call" },
 body: JSON.stringify({
 templateName:"custom-price"recipientEmail: email,
 idempotencyKey: `custom-price-${resa.id}-${Date.now()}`,
 templateData: {
 nom: name,
 depart: resa.depart,
 arrivee: resa.destination ||"—"prix: `${val.toFixed(2)} €`,
 ...
 method:"POST"headers: {"Content-Type":"application/json""X-Admin-Secret":"admin-pin-call" },
 body: JSON.stringify({
 templateName:"reschedule"recipientEmail: email,
 idempotencyKey: `reschedule-${resa.id}-${Date.now()}`,
 templateData: {
 nom: name,
 depart: resa.depart,
 arrivee: resa.destination ||"—"old_datetime:
 ...
 style={{
 marginTop: 10,
 padding:"10px 12px"background:"linear-gradient(180deg, #fff8e1 0%, #fff3c4 100%)"border:"1px solid #f59e0b"borderRadius: 12,
 fontSize: 13,
 ...
 fontSize: 11,
 fontWeight: 700,
 letterSpacing:"0.05em"textTransform:"uppercase"color:"#b45309"}}
 >
 ...
 style={{
 display:"flex"alignItems:"center"justifyContent:"space-between"gap: 8,
 background:"linear-gradient(180deg,#0f172a 0%,#1e293b 100%)"border:"1px solid #334155"borderRadius:"10px 10px 0 0"color:"#E8C96D"fontSize: 13,
 fontWeight: 700,
 padding:"8px 12px"}}
 >
 ...
 <div
 style={{
 borderLeft:"1px solid #334155"borderRight:"1px solid #334155"borderBottom:"1px solid #334155"borderRadius:"0 0 10px 10px"padding: 8,
 background:"#0b1220"}}
 >
 ...
 style={{
 width:"100%"textAlign:"left"background:"#f8fafc"border:"1px solid #e2e8f0"borderRadius: 12,
 padding:"10px 14px"fontSize: 13,
 fontWeight: 600,
 color:"#0f172a"cursor:"pointer"marginBottom: customPrixOpen? 8: 10,
 }}
 >
 ...
 border:"1px solid #cbd5e1"fontSize: 16,
 marginBottom: 8,
 fontFamily:"'DM Sans'sans-serif"background:"#ffffff"color:"#0f172a"fontWeight: 600,
 outline:"none"transition:"border-color 120ms ease, box-shadow 120ms ease"WebkitAppearance:"none"appearance:"none"boxSizing:"border-box"}}
 />
 ...
 flex: 1,
 minWidth: 70,
 background:"#faf5ff"border:"1px solid #e9d5ff"color:"#7e22ce"borderRadius: 10,
 ...
 flex: 1,
 minWidth: 70,
 background:"#f0fdf4"border:"1px solid #bbf7d0"color:"#15803d"borderRadius: 10,
 padding:"8px"fontSize: 12,
 fontWeight: 700,
 cursor:"pointer"}}
 >
 ...
 flex: 1,
 minWidth: 70,
 background:"#fffbeb"border:"1px solid #fde68a"color:"#92400e"borderRadius: 10,
 padding:"8px"fontSize: 12,
 fontWeight: 700,
 cursor:"pointer"}}
 >
 ...
 padding:"10px 14px"fontSize: 13,
 fontWeight: 600,
 color:"#0f172a"cursor:"pointer"marginBottom: changeHeureOpen? 8: 10,
 }}
 >
 ...
 const gmaps = waypointCoord? `comgooglemaps://?saddr=${originNative}&daddr=${waypointCoord}+to:${destinationNative}&directionsmode=driving&dir_action=navigate`: `comgooglemaps://?saddr=${originNative}&daddr=${destinationNative}&directionsmode=driving&dir_action=navigate`;
 ...
 const gmapsAndroid = waypointCoord? `comgooglemaps://?saddr=${originNative}&daddr=${destinationNative}&waypoints=${waypointCoord}&directionsmode=driving&dir_action=navigate`: androidNavigation;
 ...
 style={{
 width:"100%"display:"block"textAlign:"center"background:"#0f172a"color:"#fff"border:"none"borderRadius: 12,
 padding:"13px 8px"fontSize: 14,
 fontWeight: 700,
 ...
 disabled={progressing}
 style={{
 width:"100%"background:"#eff6ff"border:"2px solid #2563eb"color:"#1d4ed8"borderRadius: 12,
 ...
 disabled={progressing}
 style={{
 width:"100%"background:"#f5f3ff"border:"2px solid #7c3aed"color:"#6d28d9"borderRadius: 12,
 padding:"12px"fontSize: 14,
 fontWeight: 800,
 cursor:"pointer"marginBottom: 10,
 }}
 ...
 disabled={completing}
 style={{
 width:"100%"background:"#f0fdf4"border:"2px solid #16a34a"color:"#15803d"borderRadius: 12,
 padding:"12px"fontSize: 14,
 fontWeight: 800,
 cursor:"pointer"marginBottom: 10,
 }}
 ...
 background:"none"border:"none"color:"#b91c1c"fontSize: 11.5,
 fontWeight: 600,
...
function PlanningTab() {
 ...
 useEffect(() => {
 load();
 const ch = (supabase as any).channel("drv-planning").on("postgres_changes"{ event:"*"schema:"public"table:"reservations" }, load).subscribe();
 return () => {
 supabase.removeChannel(ch);
 };
 }, [load]);
 ...
 terminee:"#94a3b8"completed:"#94a3b8"pending:"#f59e0b"accepted:"#22c55e"en_route:"#3b82f6"arrived:"#3b82f6"};
...
function AvisTab({ onBadgeChange }: { onBadgeChange: (n: number) => void }) {
 ...
 useEffect(() => {
 load();
 const ch = (supabase as any).channel("drv-avis").on("postgres_changes"{ event:"*"schema:"public"table:"avis" }, load).subscribe();
 const poll = setInterval(load, 15000);
 const onVisible = () => {
 if (!document.hidden) load();
 };
 ...
 method:"PATCH"headers: {"Content-Type":"application/json""x-driver-token": getDriverToken() },
 body: JSON.stringify({ id, status: action }),
 });
 const result = await response.json().catch(() => ({}));
 if (!response.ok) throw new Error(result.error ||"modération impossible");
 toast.success(
 action ==="approved"?"Avis publié ✓": action ==="flagged"?"Avis signalé et retiré du site": action ==="pending"?"Avis remis en attente":"Avis refusé");
 load();
 } catch (e: any) {
 toast.error("Erreur:" + (e.message?? e));
 } finally {
 ...
 try {
 const response = await fetch("/api/public/reviews"{
 method:"DELETE"headers: {"Content-Type":"application/json""x-driver-token": getDriverToken() },
 ...
 disabled={busy === a.id}
 style={{
 background:"none"border:"none"color:"#b45309"fontSize: 11.5,
 fontWeight: 600,
 cursor:"pointer"padding: 0,
 marginLeft: 12,
 }}
...
function ClientsTab() {
 ...
 name: r.client_name ||"Client"nbCourses: isCompleted? 1: 0,
 totalDepense: isCompleted? (r.prix_estime?? 0): 0,
 derniereCourse: r.pickup_datetime?? r.date_heure,
 derniereDepart: r.depart??""derniereDestination: r.destination??""});
 } else {
 if (isCompleted) {
 ...
 useEffect(() => {
 load();
 const ch = (supabase as any).channel("drv-clients").on("postgres_changes"{ event:"*"schema:"public"table:"reservations" }, load).on("postgres_changes"{ event:"*"schema:"public"table:"clients" }, load).subscribe();
 return () => {
 supabase.removeChannel(ch);
 };
 }, [load]);
 ...
 const filtered = query.trim()? clients.filter(
 (c) =>
 ...
 padding:"10px"color:"#15803d"fontWeight: 700,
 fontSize: 13,
 textDecoration:"none"}}
 >
 📞 Appeler
 ...
 padding:"10px"color:"#1d4ed8"fontWeight: 700,
 fontSize: 13,
 textDecoration:"none"}}
 >
 💬 SMS
 ...
 style={{
 display:"flex"alignItems:"center"justifyContent:"center"gap: 6,
 width:"100%"background:"#eff6ff"border:"1px solid #bfdbfe"borderRadius: 12,
 padding:"10px"color:"#1e40af"fontWeight: 700,
 fontSize: 13,
...
function TrackingAnalytics() {
 ...
 (supabase as any).from("tracking_events").select("reservation_id, created_at, source, reservations(client_name)").eq("event_type""tracking_opened").gte("created_at"since30j.toISOString()).order("created_at"{ ascending: false }).limit(500),
 (supabase as any).from("reservations").select("id"{ count:"exact"head: true }).in("status"["accepted""en_route""arrived""completed"]).gte("pickup_datetime"since30j.toISOString()),
 ]);
 ...
 const parSource = Array.from(parSourceMap.entries()).map(([source, count]) => ({ source, count })).sort((a, b) => b.count - a.count);
 ...
 push:"🔔"email:"✉️"sms:"💬"whatsapp:"🟢"direct:"🔗"};
 ...
 style={{
 width:"100%"display:"flex"alignItems:"center"justifyContent:"space-between"background: open?"#0f172a":"#f8fafc"border: `1px solid ${open?"#0f172a":"#e2e8f0"}`,
 borderRadius: 14,
 padding:"12px 16px"fontSize: 13,
 fontWeight: 700,
 color: open?"#fff":"#0f172a"cursor:"pointer"marginBottom: open? 10: 0,
 fontFamily:"'DM Sans'sans-serif"}}
 >
 ...
 fontSize: 11,
 fontWeight: 700,
 color:"#94a3b8"letterSpacing:"0.06em"textTransform:"uppercase"marginBottom: 8,
 }}
 >
 7 derniers jours
 </div>
 ...
 <div
 style={{
 width:"100%"borderRadius:"4px 4px 0 0"background: i === data.parJour.length - 1?"#0f172a":"#bfdbfe"height: `${Math.max(4, Math.round((d.count / maxJour) * 44))}px`,
 ...
 left:"50%"transform:"translateX(-50%)"fontSize: 9,
 fontWeight: 700,
 ...
 color: i === data.parJour.length - 1?"#0f172a":"#94a3b8"fontWeight: i === data.parJour.length - 1? 700: 400,
 ...
 key={i}
 style={{
 display:"flex"justifyContent:"space-between"alignItems:"center"padding:"6px 0"borderBottom: i < data.dernierEvents.length - 1?"1px solid #f1f5f9":"none"}}
 >
 <div>
 ...
 style={{
 marginTop: 12,
 width:"100%"background:"#f1f5f9"border:"1px solid #e2e8f0"borderRadius: 10,
 padding:"8px"fontSize: 12,
 fontWeight: 700,
...
function VisitorCounter({
 ...
 width: 10,
 height: 10,
 borderRadius:"50%"background: count === null?"#94a3b8": isActive?"#22c55e":"#e2e8f0"flexShrink: 0,
...
function SimulateurTab() {
 ...
 border:"1px solid #e2e8f0"fontSize: 16,
 fontFamily:"'DM Sans'sans-serif"color:"#0f172a"background:"#fff"colorScheme:"light"};
 ...
 style={{
 flex: 1,
 padding:"10px"minHeight: 44,
 borderRadius: 10,
 fontWeight: 700,
 fontSize: 13,
 cursor:"pointer"border: mode ==="manuel"?"2px solid #2563eb":"1px solid #e2e8f0"background: mode ==="manuel"?"#eff6ff":"#fff"color: mode ==="manuel"?"#1d4ed8":"#475569"}}
 >
 🧮 Km
 </button>
 <button
 ...
 fontWeight: 700,
 fontSize: 13,
 cursor:"pointer"border: mode ==="adresses"?"2px solid #2563eb":"1px solid #e2e8f0"background: mode ==="adresses"?"#eff6ff":"#fff"color: mode ==="adresses"?"#1d4ed8":"#475569"}}
 >
 📍 Adresses
 </button>
 </div>
 ...
 style={{
 width:"100%"background:"#0b1224"color:"#fff"border:"none"borderRadius: 12,
 padding:"13px"minHeight: 46,
 fontSize: 14,
 fontWeight: 800,
 ...
 fontSize: 14,
 fontWeight: 800,
 cursor: loadingRoute?"default":"pointer"marginBottom: 14,
 ...
 style={{
 background: result.label.includes("mixte")?"#fdf4ff": result.label.includes("nuit")?"#eff6ff":"#f0fdf4"color: result.label.includes("mixte")?"#a21caf": result.label.includes("nuit")?"#1d4ed8":"#15803d"}}
 >
 {result.label}
 </span>
 </div>
...
const DRIVER_LABEL: Record<string, string> = {
 patricia:"Patricia"alain:"Alain"non_attribuee:"Non attribuée"};
...
function StatsTab() {
 ...
 const ch = (supabase as any).channel("drv-stats").on("postgres_changes"{ event:"*"schema:"public"table:"reservations" }, () => load()).subscribe();
 const onVis = () => {
 if (!document.hidden) load();
 };
 document.addEventListener("visibilitychange"onVis);
 ...
 background: days === d?"#0B0B0D":"#fff"color: days === d?"#C6A24A":"#334155"fontSize: 12,
 fontWeight: 700,
 cursor:"pointer"minHeight: 36,
 }}
 >
 ...
 {data.drivers.filter((d: any) => d.total > 0 || d.driver!=="non_attribuee").map((d: any) => (
 ...
 background: d.driver ==="patricia"?"#fdf2f8": d.driver ==="alain"?"#eff6ff":"#f1f5f9"color: d.driver ==="patricia"?"#9d174d": d.driver ==="alain"?"#1d4ed8":"#475569"}}
 >
 ...
 <div
 style={{
 width:"100%"borderRadius:"4px 4px 0 0"background:"#0f172a"height: `${Math.max(6, (d.count / maxDay) * 52)}px`,
 }}
 />
 </div>
 ))}
...
function HistoriqueTab({ driverId }: { driverId?: string }) {
 ...
 const ch = (supabase as any).channel("drv-history").on("postgres_changes"{ event:"*"schema:"public"table:"reservations" }, () => load()).subscribe();
 return () => {
 clearInterval(t);
 supabase.removeChannel(ch);
 };
 ...
 accepted:"✅ Acceptée"en_route:"🚖 En route"arrived:"📍 Prise en charge"completed:"🏁 Terminée"terminee:"🏁 Terminée"cancelled:"✖ Annulée / refusée"};
 ...
 background: filter === o.k?"#0B0B0D":"#fff"color: filter === o.k?"#C6A24A":"#334155"fontSize: 12.5,
 fontWeight: 700,
 ...
 background: e.driver ==="patricia"?"#fdf2f8":"#eff6ff"color: e.driver ==="patricia"?"#9d174d":"#1d4ed8"}}
 >
...
function PushDiagnostic() {
 ...
 style={{
 width:"100%"textAlign:"center"background:"none"border:"none"color:"#94a3b8"fontSize: 12,
