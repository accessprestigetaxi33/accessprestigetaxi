...
const DESC_FR ="Mentions légales d'Access Prestige Taxi: éditeur du site, hébergement, propriété intellectuelle et contact.";
...
const COPY = {
 fr: {
 eyebrow:"Informations légales"h1:"Mentions légales"updated:"Dernière mise à jour"publisherTitle:"Éditeur du site"publisherIntro: (
 ...
 publisherDirTitle:"Directeur de la publication"publisherDirText:"Le responsable de la publication est l'exploitant d'Access Prestige Taxi."hostingTitle:"Hébergement"hostingText: (
 <>Le site est hébergé par <strong>Cloudflare, Inc.</strong> — 101 Townsend Street, San Francisco, CA 94107, USA.</>
 ),
 ipTitle:"Propriété intellectuelle"ipText:"L'ensemble des contenus présents sur ce site (textes, images, logos, graphismes, code source) est protégé par le droit d'auteur. Toute reproduction, représentation, modification ou exploitation, totale ou partielle, sans autorisation écrite préalable, est interdite."liabilityTitle:"Responsabilité"liabilityText:"Les informations diffusées (tarifs, disponibilités, estimations) sont indicatives. Le compteur taxi homologué fait foi pour la facturation finale conformément à la réglementation en vigueur (arrêtés préfectoraux de la Charente et de la Charente-Maritime)."contactTitle:"Contact"contactText: (
 <>
 ...
 en: {
 eyebrow:"Legal information"h1:"Legal Notice"updated:"Last updated"publisherTitle:"Website publisher"publisherIntro: (
 ...
 publisherDirTitle:"Publication director"publisherDirText:"The person responsible for publication is the operator of Access Prestige Taxi."hostingTitle:"Hosting"hostingText: (
 <>The website is hosted by <strong>Cloudflare, Inc.</strong> — 101 Townsend Street, San Francisco, CA 94107, USA.</>
 ),
 ipTitle:"Intellectual property"ipText:"All content on this website (text, images, logos, graphics, source code) is protected by copyright. Any reproduction, representation, modification or use, in whole or in part, without prior written permission is prohibited."liabilityTitle:"Liability"liabilityText:"The information published (fares, availability, estimates) is provided for guidance only. The approved taxi meter is authoritative for final billing, in accordance with applicable regulations (prefectoral orders for Charente-Maritime)."contactTitle:"Contact"contactText: (
 <>
