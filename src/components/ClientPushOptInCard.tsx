...
const COPY = {
 fr: {
 iosInstallToast:"Sur iPhone, installez d'abord l'app: Safari → Partager → Sur l'écran d'accueil, puis rouvrez depuis l'icône."deniedToast:"Notifications refusées dans les réglages du navigateur."tokenMissingToast:"Token FCM introuvable — vérifiez que l'app est installée sur l'écran d'accueil (iOS)"genericErrorToast: (msg: string) => `Erreur: ${msg}`,
 unknownError:"inconnue"iosInstallTitle:"Installation requise sur iPhone"iosInstallDesc: (
 <>
 ...
 en: {
 iosInstallToast:"On iPhone, first install the app: Safari → Share → Add to Home Screen, then reopen it from the icon."deniedToast:"Notifications were denied in your browser settings."tokenMissingToast:"FCM token not found — make sure the app is installed on the home screen (iOS)"genericErrorToast: (msg: string) => `Error: ${msg}`,
 unknownError:"unknown"iosInstallTitle:"Installation required on iPhone"iosInstallDesc: (
 <>
