...
export function ListeningOverlay({
 open,
 label ="Je vous écoute…"hint ="Parlez clairement. Touchez « Arrêter » pour valider."onCancel,
 transcript,
 errorMessage,
 onRetry,
 retryLabel ="Réessayer"}: ListeningOverlayProps) {
 ...
 zIndex: 9999,
 background:"rgba(10, 10, 20, 0.78)"backdropFilter:"blur(8px)"WebkitBackdropFilter:"blur(8px)"display:"flex"flexDirection:"column"alignItems:"center"justifyContent:"center"padding:"calc(24px + env(safe-area-inset-top, 0px)) 20px calc(24px + env(safe-area-inset-bottom, 0px))"animation:"fadeIn 180ms ease-out"}}
 >
 <style>{`
 ...
 width: 96,
 height: 96,
 borderRadius:"50%"background:"linear-gradient(135deg, #f5c842 0%, #d4a017 100%)"display:"grid"placeItems:"center"color:"#1a1a2e"animation:"micPulse 1.6s ease-out infinite"marginBottom: 24,
 }}
 >
 ...
 height: 32,
 borderRadius: 3,
 background:"#f5c842"animationDelay: `${delay}ms`,
 }}
 />
 ))}
 </div>
 ...
 role="alert"
 style={{
 color:"#fecaca"background:"rgba(220,38,38,0.15)"border:"1px solid rgba(220,38,38,0.35)"borderRadius: 12,
 ...
 <div
 style={{
 color:"#fff"background:"rgba(255,255,255,0.08)"border:"1px solid rgba(255,255,255,0.15)"borderRadius: 12,
 ...
 border:"1px solid rgba(245,200,66,0.5)"background:"rgba(245,200,66,0.15)"color:"#f5c842"fontSize: 15,
 fontWeight: 700,
 ...
 border:"1px solid rgba(255,255,255,0.2)"background:"rgba(255,255,255,0.08)"color:"#fff"fontSize: 15,
 fontWeight: 700,
 cursor:"pointer"display:"inline-flex"alignItems:"center"gap: 8,
 touchAction:"manipulation"}}
 >
