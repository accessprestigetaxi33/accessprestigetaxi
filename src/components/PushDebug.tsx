...
export function PushDebug() {
 ...
 body:"Si tu vois ça, le SW fonctionne!"icon:"/favicon.ico"tag:"push-debug-test"});
 ...
 info:"#94a3b8"ok:"#4ade80"error:"#f87171"};

 return (
 <div style={{
 position:"fixed"bottom: 0, left: 0, right: 0, zIndex: 9999,
 background:"#0f172a"color:"#e2e8f0"fontFamily:"monospace"fontSize: 12,
 maxHeight:"55vh"display:"flex"flexDirection:"column"borderTop:"2px solid #334155"}}>
 ...
 disabled={running}
 style={{
 background: running?"#334155":"#3b82f6"color:"#fff"border:"none"borderRadius: 6, padding:"4px 12px"cursor: running?"default":"pointer"fontSize: 12,
 }}
 >
