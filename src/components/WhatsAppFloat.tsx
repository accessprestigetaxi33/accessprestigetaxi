...
export function WhatsAppFloat() {
 ...
 trackCtaClick({
 event_type: action ==="whatsapp"?"whatsapp_click": action ==="call"?"call_click":"quote_click"variant,
 ...
 fontWeight: 700,
 fontSize:"clamp(11px, 3.2vw, 13px)"textDecoration:"none"color:"#fff"minHeight: 56,
 lineHeight: 1.1,
 };
 ...
 bottom: 0,
 zIndex: 9999,
 background:"rgba(15,23,42,0.96)"backdropFilter:"blur(10px)"borderTop:"1px solid rgba(148,163,184,0.2)"padding:"8px 10px calc(8px + env(safe-area-inset-bottom)) 10px"display:"flex"gap: 8,
 }}
 role="navigation"
