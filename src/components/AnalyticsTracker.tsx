...
export function AnalyticsTracker() {
 ...
 const el = (e.target as HTMLElement | null)?.closest?.("a[href], button[data-analytics]"
 ) as HTMLElement | null;
 if (!el) return;
 ...
 const event =
 name??
 (path.startsWith("/reservation") || path.startsWith("/reserver")?"reservation_submitted": path.startsWith("/contact")?"contact_submitted":"form_submit");
