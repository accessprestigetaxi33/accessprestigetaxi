...
const baseSkel: CSSProperties = {
 display:"block"background:"linear-gradient(90deg, rgba(255,255,255,0.04) 0%, rgba(255,255,255,0.10) 50%, rgba(255,255,255,0.04) 100%)"backgroundSize:"800px 100%"animation:"adminSkelShimmer 1.4s ease-in-out infinite"borderRadius: 8,
};
...
export function Skeleton({ width ="100%"height = 14, radius, style }: SkeletonProps) {
 ...
 width,
 height,
 borderRadius: radius?? baseSkel.borderRadius,...style,
 }}
 />
 );
}
...
export function GpsCardSkeleton() {
 ...
 style={{
 maxWidth: 540,
 margin:"0 auto"background:"rgba(255,255,255,0.04)"border:"1px solid rgba(255,255,255,0.08)"borderRadius: 24,
...
export function MapSkeleton() {
 ...
 <div
 style={{
 width:"100%"height:"100%"background:"rgba(255,255,255,0.03)"display:"flex"flexDirection:"column"alignItems:"center"justifyContent:"center"gap: 16,
 position:"relative"overflow:"hidden"}}
 >
 <div
 style={{
 position:"absolute"inset: 0,
 display:"grid"gridTemplateColumns:"repeat(4, 1fr)"gridTemplateRows:"repeat(4, 1fr)"gap: 1,
 opacity: 0.25,
 }}
 >
...
export function GlobalLoadingOverlay({ visible }: { visible: boolean }) {
 ...
 zIndex: 9999,
 background:"rgba(10,15,30,0.75)"backdropFilter:"blur(4px)"display:"flex"flexDirection:"column"alignItems:"center"justifyContent:"center"gap: 16,
 }}
 >
 ...
 width: 56,
 height: 56,
 borderRadius:"50%"border:"4px solid rgba(14,165,233,0.2)"borderTop:"4px solid #0ea5e9"animation:"spin 0.8s linear infinite"}}
 />
 <div
 style={{
