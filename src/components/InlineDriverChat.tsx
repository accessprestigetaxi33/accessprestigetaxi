...
const COPY = {
 fr: {
 empty:"Aucun message pour l'instant."placeholder:"Répondre au client…"send:"Envoyer"sendFailed:"Envoi impossible, réessaie."},
 en: {
 empty:"No messages yet."placeholder:"Reply to the client…"send:"Send"sendFailed:"Could not send, please try again."},
} as const;
...
export function InlineDriverChat({ reservationId, onUnreadChange }: Props) {
 ...
 style={{
 marginTop: 8,
 background:"#FBF7EE"border:"1px solid #E8DFCB"borderRadius: 12,
 padding: 10,
 }}
 >
 <div
 ...
 style={{
 maxHeight: 200,
 overflowY:"auto"background:"#ffffff"border:"1px solid #EEE6D2"borderRadius: 8,
 padding: 8,
 marginBottom: 8,
 }}
 >
 ...
 <div
 style={{
 maxWidth:"78%"background: mine?"linear-gradient(135deg,#C9A84C,#E8C96D)":"#F5EEDC"color:"#0f172a"border: mine?"none":"1px solid #E8DFCB"borderRadius: 12,
 ...
 background:"#ffffff"color:"#000000"border:"1px solid #E8DFCB"borderRadius: 10,
 ...
 height: 40,
 borderRadius: 10,
 background:"linear-gradient(135deg,#C9A84C,#E8C96D)"color:"#000"border:"none"display:"flex"alignItems:"center"justifyContent:"center"cursor: sending ||!input.trim()?"not-allowed":"pointer"opacity: sending ||!input.trim()? 0.5: 1,
 flexShrink: 0,
 }}
 aria-label={c.send}
 >
