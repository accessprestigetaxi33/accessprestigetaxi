...
export const template = {
  ...
  subject: (d: Record<string, any>) =>
    d?.prix ? `Votre tarif personnalisé : ${d.prix} — Accès Prestige Taxi` : "Votre tarif personnalisé — Accès Prestige Taxi",
  displayName: "Tarif personnalisé",
  previewData: {
    nom: "Jean Dupont",
    depart: "Bordeaux Centre",
    arrivee: "Arcachon",
    pickup_datetime: "samedi 16 mai 2026 à 09:00",
    prix: "95,00 €",
    ancien_prix: "110,00 €",
    message: "Tarif forfaitaire négocié pour ce trajet longue distance.",
