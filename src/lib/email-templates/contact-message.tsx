...
export const template = {
 ...
 displayName:'Message de contact'to:'contact@accesprestigetaxi.fr'previewData: {
 nom:'Marie Dupont'email:'marie@example.com'telephone:'06 12 34 56 78'sujet:'Devis longue distance'message:'Bonjour, je souhaiterais un devis pour un trajet en véhicule électrique dimanche prochain. Merci!'},
