...
export const template = {
 ...
 displayName:"Nouvelle réservation — chauffeurs"to:"contact@accesprestigetaxi.fr"previewData: {
 nom:"Jean Dupont"phone:"06 12 34 56 78"email:"jean@example.com"depart:"12 cours de l'Intendance, Bordeaux"arrivee:"Aéroport Mérignac"pickup_datetime:"2026-05-10T14:30:00+00:00"passagers: 2,
 bagages: 2,
...
const button = {
 background:"#C6A24A"color:"#0B0B0D"padding:"12px 28px"borderRadius:"8px"fontWeight:"bold" as const,
