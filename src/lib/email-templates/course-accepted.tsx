...
const card = {
 background:"#fafafa"border:"1px solid #eee"borderRadius:"8px"padding:"14px 18px"margin:"8px 0 22px"};
const row = { fontSize:"14px"color:"#222"margin:"5px 0"lineHeight:"1.6" };
const rowLabel = { color:"#666"fontWeight: 600 as const };

export const template = {
 component: Email,
 subject:"Votre course est confirmée — Accès Prestige Taxi"displayName:"Course acceptée — confirmation complète"previewData: {
 nom:"Jean Dupont"depart:"20 Av. Jean Monnet, Bordeaux"arrivee:"Aéroport de Bordeaux-Mérignac"pickup_datetime:"jeudi 14 mai 2026 à 20:22"tracking_url:"https://accesprestigetaxi.fr/suivi/abcd-1234"prix:"13.50 €"tarif:"Nuit"passagers: 1,
 bagages: 0,
 },
