...
const STR: Record<Lang, Record<string, string>> = {
 fr: {
 preview:"Confirmation de votre réservation — votre lien de suivi est ici"hi:"Bonjour"thanks:"Nous avons bien reçu votre demande de réservation. Votre chauffeur vous confirmera la course rapidement, en véhicule 100 % électrique."when:"Date / heure"from:"Départ"to:"Arrivée"pax:"Passagers"lug:"Bagages"ref:"N° de réservation"suivi_btn:"Suivre ma course en temps réel"suivi_label:"Lien de suivi:"foot:"Accès Prestige Taxi — votre mobilité, notre priorité"unsub:"Vous recevez cet email car vous avez effectué une réservation. Ne plus recevoir ces emails"subj:"Confirmation de votre réservation — Accès Prestige Taxi"},
 en: {
 preview:"Booking confirmation — your tracking link is here"hi:"Hello"thanks:"We've received your booking request. Your driver will confirm your ride shortly, in a 100% electric vehicle."when:"Date / time"from:"From"to:"To"pax:"Passengers"lug:"Luggage"ref:"Booking number"suivi_btn:"Track my ride in real time"suivi_label:"Tracking link:"foot:"Accès Prestige Taxi — your mobility, our priority"unsub:"You're receiving this email because you made a booking. Unsubscribe"subj:"Your booking confirmation — Accès Prestige Taxi"},
};
...
export const template = {
 ...
 displayName:"Confirmation client réservation"previewData: {
 lang:"fr"nom:"Jean Dupont"pickup_datetime:"2026-05-10T14:30:00+00:00"depart:"Bordeaux"arrivee:"Aéroport Mérignac"passagers: 2,
 bagages: 2,
 reservation_id:"abcdef12-0000-0000-0000-000000000000"suivi_url:"https://accesprestigetaxi.fr/suivi/APT-ABCDEF12"},
...
const btnSuivi = {
 backgroundColor:"#C6A24A"borderRadius:"8px"color:"#0B0B0D"fontSize:"15px"fontWeight:"700"padding:"14px 28px"textDecoration:"none"display:"inline-block"};
