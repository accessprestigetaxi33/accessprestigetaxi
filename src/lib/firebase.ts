...
export const firebaseConfig = {
 apiKey:"AIzaSyB8wYcBq5-KVdPDAnXGcWzcCkTYmftTKdY"authDomain:"taxi-city-bordeaux.firebaseapp.com"projectId:"taxi-city-bordeaux"storageBucket:"taxi-city-bordeaux.firebasestorage.app"messagingSenderId:"702667833979"appId:"1:702667833979:web:653978ae325adfa06898de"};
...
export function setupForegroundNotifications(): () => void {
 ...
 const options = {
 body: payload.notification?.body??""icon: payload.notification?.icon??"/favicon.ico"badge:"/favicon.ico"tag: payload.data?.tag??"taxi-fcm"data: payload.data?? {},
 vibrate: [200, 100, 200],
