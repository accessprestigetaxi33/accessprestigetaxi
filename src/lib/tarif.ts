...
export function parseAsParisTime(iso: string): Date {
 ...
 timeZone:"Europe/Paris"hour:"2-digit"minute:"2-digit"hourCycle:"h23"}).formatToParts(provisional);
...
export function partsParis(iso: string): {
 ...
 const parts = new Intl.DateTimeFormat("en-GB"{
 timeZone:"Europe/Paris"year:"numeric"month:"2-digit"day:"2-digit"hour:"2-digit"minute:"2-digit"hourCycle:"h23"weekday:"short"}).formatToParts(date);
